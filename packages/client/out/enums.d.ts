...
declare namespace CyberEnums {
    declare const enum $REDSCRIPT_SIGNATURE {
    ...
    declare const enum AICombatSpaceSize {
      "Undefined" = 0,
      "Narrow" = 1,
      "Medium" = 2,
      "Huge" = 3,
    ...
    declare const enum AICommandContextsType {
      "Default" = 0,
      "Immediate" = 1,
      "Movement" = 2,
      "Workspot" = 3,
    ...
    declare const enum AICommandState {
      "NotExecuting" = 0,
      "Enqueued" = 1,
      "Executing" = 2,
      "Cancelled" = 3,
    ...
    declare const enum AICoverExposureMethod {
    ...
    declare const enum AIEExecutionOutcome {
      "OUTCOME_FAILURE" = 0,
      "OUTCOME_SUCCESS" = 1,
      "OUTCOME_IN_PROGRESS" = 2,
    }

    declare const enum AIEExecutionStatus {
      "STATUS_INVALID" = 0,
      "STATUS_SUCCESS" = 1,
      "STATUS_FAILURE" = 2,
      "STATUS_RUNNING" = 3,
    ...
    declare const enum AIEInterruptionImportance {
      "Undefined" = 0,
      "Casual" = 1,
      "Rush" = 2,
      "Immediate" = 3,
    ...
    declare const enum AIEInterruptionOutcome {
      "INTERRUPTION_SUCCESS" = 0,
      "INTERRUPTION_DELAYED" = 1,
      "INTERRUPTION_FAILED" = 2,
    }

    declare const enum AIESharedVarDefinitionType {
      "SVInt" = 0,
      "SVFloat" = 1,
      "SVBool" = 2,
      "SVName" = 3,
    ...
    declare const enum AIFiniteRoleType {
      "Patrol" = 0,
    }

    declare const enum AIForcedBehaviourPriority {
      "AboveIdle" = 0,
      "AboveCombat" = 1,
    ...
    declare const enum AIPatrolContinuationPolicy {
      "FromNextControlPoint" = 0,
      "FromClosestPoint" = 1,
      "FromBeginning" = 2,
    }

    declare const enum AIReactionCountOutcome {
      "Failed" = 0,
      "Succeded" = 1,
      "NotFound" = 2,
    }

    declare const enum AISignalFlags {
      "Undefined" = 0,
      "OverridesSelf" = 1,
    ...
    declare const enum AISocketsForRig {
      "Undefined" = 0,
      "ManAverage" = 1,
      "ManBig" = 2,
      "ManFat" = 3,
    ...
    declare const enum AISquadType {
      "Community" = 0,
      "Combat" = 4,
      "Follower" = 6,
      "Unknown" = 7,
    ...
    declare const enum AIThreatPersistenceStatus {
      "ThreatNotFound" = 0,
      "Persistent" = 1,
      "NotPersistent" = 2,
    }

    declare const enum AITrackedStatusType {
      "Unknown" = 0,
      "Friendly" = 1,
      "Neutral" = 2,
      "Hostile" = 3,
    ...
    declare const enum AIUninterruptibleActionType {
      "None" = 0,
      "Default" = 1,
      "EnteringCover" = 2,
      "LeavingCover" = 3,
    ...
    declare const enum ArcadeMinigame {
      "Quadracer" = 0,
      "RoachRace" = 1,
      "Shooter" = 2,
      "Tank" = 3,
    ...
    declare const enum AttitudeChange {
      "DONT_CHANGE" = 0,
      "FRIENDLY" = 1,
      "NEUTRAL" = 2,
      "HOSTILE" = 3,
    ...
    declare const enum AttributeButtonState {
      "Default" = 0,
      "Hover" = 1,
    }
    ...
    declare const enum BarType {
      "Armor" = 0,
      "CurrentCapacity" = 1,
      "Edgerunner" = 2,
    }

    declare const enum BlacklistReason {
      "UNINITIALIZED" = 0,
      "TRESPASSING" = 1,
      "REPRIMAND" = 2,
      "COMBAT" = 3,
    ...
    declare const enum BusySwitchingReason {
      "AVAILABLE" = 0,
      "RANDOMIZING" = 1,
      "SWAPPING" = 2,
    }

    declare const enum ButtonStatus {
      "DEFAULT" = 0,
      "PROCESSING" = 1,
      "DISABLED" = 2,
    }

    declare const enum CasinoTableBet {
      "none" = 0,
      "on_0" = 1,
      "on_00" = 2,
      "on_1" = 3,
    ...
    declare const enum CasinoTableSlot {
      "Slot1" = 0,
      "Slot2" = 1,
      "Slot3" = 2,
      "Slot4" = 3,
    ...
    declare const enum CasinoTableState {
      "Idle" = 0,
      "Game" = 1,
    }

    declare const enum CharacterScreenType {
      "Attributes" = 0,
      "Perks" = 1,
    }

    declare const enum ChargeIndicatorWidgetType {
      "INVALID" = 0,
      "JENKINS" = 1,
      "TIMEBANK" = 2,
    }

    declare const enum ClueState {
      "active" = 0,
      "complete" = 1,
    }

    declare const enum CodexCategoryType {
      "All" = 0,
      "Database" = 1,
      "Characters" = 2,
      "Locations" = 3,
    ...
    declare const enum CodexDataSource {
      "Undefined" = 0,
      "Codex" = 1,
      "Onscreen" = 2,
    }

    declare const enum CodexImageType {
      "Default" = 0,
      "Character" = 1,
    }
    ...
    declare const enum ConfigMeshQualityLevel {
      "Default" = 0,
      "Console" = 1,
      "Console_XboxSeriesS" = 2,
    }

    declare const enum ConfigTextureQualityLevel {
      "Console" = 0,
      "ConsoleSafe" = 1,
      "Low" = 2,
      "Medium" = 3,
    ...
    declare const enum ContactsSortMethod {
      "ByTime" = 0,
      "ByName" = 1,
    }
    ...
    declare const enum CrafringMaterialItemHighlight {
      "None" = 0,
      "Hover" = 1,
      "Add" = 2,
      "Remove" = 3,
    ...
    declare const enum CraftingCommands {
      "CraftingFinished" = 0,
    ...
    declare const enum CraftingMode {
      "craft" = 0,
      "upgrade" = 1,
    }

    declare const enum CraftingNotificationType {
      "NoPerks" = 0,
      "NotEnoughMaterial" = 1,
    }

    declare const enum CurrencyNotificationAnimState {
      "Inactive" = 0,
      "Intro" = 1,
      "Active" = 2,
      "Outro" = 3,
    ...
    declare const enum CustomWeaponWheelSlot {
      "FreeHands" = 0,
      "Fists" = 1,
    }

    declare const enum CyberwareScreenType {
      "Invalid" = 0,
      "Ripperdoc" = 1,
      "Inventory" = 2,
    }

    declare const enum DamageEffectDisplayType {
      "Flat" = 0,
      "TargetHealth" = 1,
      "Invalid" = -1,
    }
    ...
    declare const enum DerivedFilterResult {
      "False" = 0,
      "True" = 1,
      "Pass" = 2,
    }

    declare const enum DeviceStimType {
      "Distract" = 0,
      "VisualDistract" = 1,
      "Explosion" = 2,
    ...
    declare const enum DoorProximityDetectorAppearanceStateType {
      "On" = 0,
      "Off" = 1,
      "Bars" = 2,
      "Green" = 3,
    ...
    declare const enum DropdownItemDirection {
      "None" = 0,
      "Down" = 1,
      "Up" = 2,
    }
    ...
    declare const enum EAIActionState {
      "Inactive" = 0,
      "Startup" = 1,
      "Loop" = 2,
      "Recover" = 3,
    ...
    declare const enum EAIActionTarget {
      "None" = 0,
      "CombatTarget" = 1,
      "FriendlyTarget" = 2,
      "CurrentCover" = 3,
    ...
    declare const enum EAIAttitude {
      "AIA_Friendly" = 0,
      "AIA_Neutral" = 1,
      "AIA_Hostile" = 2,
    }

    declare const enum EAIBackgroundCombatStep {
      "ChangeCover" = 0,
      "ChangeTarget" = 1,
    }

    declare const enum EAIBlockDirection {
      "Undefined" = 0,
      "Center" = 1,
      "Left" = 2,
      "Right" = 3,
    ...
    declare const enum EAICombatPreset {
      "None" = 0,
      "IsReckless" = 1,
      "IsAggressive" = 2,
      "IsBalanced" = 3,
    ...
    declare const enum EAICoverAction {
      "StepOut" = 0,
      "LeanOut" = 1,
      "StepUp" = 2,
      "LeanOver" = 3,
    ...
    declare const enum EAICoverActionDirection {
      "Front" = 0,
      "FrontRight" = 1,
      "Right" = 2,
      "BackRight" = 3,
    ...
    declare const enum EAIDismembermentBodyPart {
      "NONE" = -1,
      "LEFT_ARM" = 0,
      "RIGHT_ARM" = 1,
      "LEFT_LEG" = 2,
    ...
    declare const enum EAIGateEventFlags {
      "AIGEF_Undefined" = 0,
    ...
    declare const enum EAIGateSignalFlags {
      "AIGSF_Undefined" = 0,
    ...
    declare const enum EAIHitBodyPart {
      "None" = -1,
      "Head" = 1,
      "LeftTorso" = 2,
      "RightTorso" = 3,
    ...
    declare const enum EAIHitDirection {
      "None" = -1,
      "Left" = 0,
      "Back" = 1,
      "Right" = 2,
    ...
    declare const enum EAIHitIntensity {
      "None" = -1,
      "Light" = 0,
      "Medium" = 1,
      "Heavy" = 2,
    ...
    declare const enum EAIHitSource {
      "None" = -1,
      "Ranged" = 0,
      "MeleeSharp" = 1,
      "MeleeBlunt" = 2,
    ...
    declare const enum EAILastHitReactionPlayed {
      "None" = -1,
      "Twitch" = 0,
      "Impact" = 1,
      "Stagger" = 2,
    ...
    declare const enum EAIRole {
      "None" = 0,
      "Patrol" = 1,
      "Follower" = 2,
    }

    declare const enum EAIShootingPatternRange {
      "Close" = 0,
      "Medium" = 1,
      "Long" = 2,
      "Undefined" = 3,
    ...
    declare const enum EAISquadAction {
      "Invalid" = 0,
      "Shoot" = 1,
      "Charge" = 2,
      "TakeCover" = 3,
    ...
    declare const enum EAISquadChoiceAlgorithm {
      "Invalid" = 0,
      "TargetDistance" = 1,
      "SectorDistance" = 2,
      "SquadmateDistance" = 3,
    ...
    declare const enum EAISquadRing {
      "Invalid" = 0,
      "Melee" = 1,
      "Close" = 2,
      "Medium" = 3,
    ...
    declare const enum EAISquadTactic {
      "Invalid" = 0,
      "Flanking" = 1,
      "Assault" = 2,
      "Snipe" = 3,
    ...
    declare const enum EAISquadVerb {
      "Invalid" = 0,
      "JoinSquad" = 1,
      "LeaveSquad" = 2,
      "OpenSquadAction" = 3,
    ...
    declare const enum EAITargetType {
      "AITT_Undefined" = 0,
      "AITT_Argument" = 1,
      "AITT_Owner" = 2,
      "AITT_CombatTarget" = 3,
    ...
    declare const enum EAIThreatCalculationType {
      "Regular" = 0,
      "Boss" = 1,
      "Madness" = 2,
    }

    declare const enum EAITicketStatus {
      "Invalid" = 0,
      "Evaluate" = 1,
      "OrderFail" = 2,
      "OrderDone" = 3,
    ...
    declare const enum EAnimationBufferDataAvailable {
      "ABDA_None" = 0,
      "ABDA_Partial" = 1,
      "ABDA_All" = 2,
    }
    ...
    declare const enum EAppliedTriangulationHackSpeed {
      "NotAssigned" = 0,
      "Slow" = 1,
      "Normal" = 2,
      "Fast" = 3,
    ...
    declare const enum EAreaLightShape {
      "ALS_Sphere" = 0,
      "ALS_Capsule" = 1,
    }

    declare const enum EArgumentType {
      "Object" = 0,
      "CoverID" = 1,
      "Vector4" = 2,
    }

    declare const enum EAxisType {
      "X" = 0,
      "Y" = 1,
      "Z" = 2,
    }
    ...
    declare const enum EBeamStyle {
      "None" = 0,
      "Sweeping" = 1,
      "HeadSlicer" = 2,
    }

    declare const enum EBinkOperationType {
      "PLAY" = 0,
      "STOP" = 1,
      "PAUSE" = 2,
      "RESUME" = 3,
    ...
    declare const enum EBroadcasteingType {
      "Active" = 0,
      "SingleActive" = 1,
      "Direct" = 2,
      "Remove" = 3,
    ...
    declare const enum ECameraDirectionFunctionalTestsUtil {
      "Up" = 0,
      "Down" = 1,
      "Left" = 2,
      "Right" = 3,
    ...
    declare const enum ECarryState {
      "None" = 0,
      "Pickup" = 1,
      "Carry" = 2,
      "Drop" = 3,
    ...
    declare const enum ECartOperationResult {
      "Success" = 0,
      "NoItems" = 1,
      "AllItems" = 2,
      "WontSell" = 3,
    ...
    declare const enum ECentaurShieldState {
      "Inactive" = 0,
      "Activating" = 1,
      "Active" = 2,
      "Destroyed" = 3,
    ...
    declare const enum EChargesAmount {
      "Empty" = 0,
      "Last" = 1,
      "FirstFromTop" = 2,
      "Max" = 3,
    ...
    declare const enum EChargesItem {
      "Grenade" = 0,
      "HealingItems" = 1,
    ...
    declare const enum EColorMappingFunction {
      "CMF_Linear" = 0,
      "CMF_sRGB" = 1,
      "CMF_ArriLogC" = 2,
    }

    declare const enum EColorPrimary {
      "PRIM_REC709" = 0,
      "PRIM_DCIP3" = 1,
      "PRIM_BT2020" = 2,
    }

    declare const enum ECompanionDistancePreset {
      "Medium" = 0,
      "Close" = 1,
      "Far" = 2,
      "VeryFar" = 3,
    ...
    declare const enum ECompanionPositionPreset {
      "Behind" = 0,
      "InFront" = 1,
    }

    declare const enum ECompareOp {
      "CO_Lesser" = 0,
      "CO_LesserEq" = 1,
      "CO_Greater" = 2,
      "CO_GreaterEq" = 3,
    ...
    declare const enum EComparisonOperator {
      "Equal" = 0,
      "NotEqual" = 1,
      "More" = 2,
      "MoreOrEqual" = 3,
    ...
    declare const enum EComparisonType {
      "Greater" = 0,
      "GreaterOrEqual" = 1,
      "Equal" = 2,
      "NotEqual" = 3,
    ...
    declare const enum EComponentOperation {
      "Enable" = 0,
      "Disable" = 1,
    }

    declare const enum EComputerAnimationState {
      "None" = 0,
      "Opened" = 1,
      "Closed" = 2,
    }

    declare const enum EComputerMenuType {
      "MAIN" = 0,
      "SYSTEM" = 1,
      "FILES" = 2,
      "MAILS" = 3,
    ...
    declare const enum EConclusionQuestState {
      "Undefined" = 0,
      "Active" = 1,
      "Inactive" = 2,
      "Shown" = 3,
    ...
    declare const enum ECookingPlatform {
      "PLATFORM_None" = 0,
      "PLATFORM_PC" = 1,
      "PLATFORM_XboxOne" = 2,
      "PLATFORM_PS4" = 3,
    ...
    declare const enum ECooldownGameControllerMode {
      "COOLDOWNS" = 0,
      "BUFFS_AND_DEBUFFS" = 1,
    }

    declare const enum ECooldownIndicatorState {
      "Pooled" = 0,
      "Intro" = 1,
      "Filling" = 2,
      "Outro" = 3,
    ...
    declare const enum ECoverSpecialAction {
      "None" = 0,
      "Left" = 1,
      "Right" = 2,
    }

    declare const enum ECraftingIconPositioning {
      "generic" = 0,
      "weaponBig" = 1,
      "weaponSmall" = 2,
    }

    declare const enum ECubeSourceTextureType {
      "CST_CrossHorizontal" = 0,
      "CST_CrossVertical" = 1,
      "CST_Panorama" = 2,
    }

    declare const enum ECustomCameraTarget {
      "ECCTV_All" = 0,
      "ECCTV_OnlyOffscreen" = 1,
      "ECCTV_OnlyOnscreen" = 2,
    }

    declare const enum ECustomFilterDPadNavigationOption {
      "SelectNext" = 0,
      "SelectPrev" = 1,
      "Toggle" = 2,
    }

    declare const enum ECustomMaterialParam {
      "ECMP_CustomParam0" = 1,
      "ECMP_CustomParam1" = 2,
      "ECMP_CustomParam2" = 4,
      "ECMP_CustomParam3" = 8,
    ...
    declare const enum EDebuggerColor {
      "RED" = 0,
      "YELLOW" = 1,
    }

    declare const enum EDecalRenderMode {
      "DRM_AllStatic" = 0,
      "DRM_ObjectType" = 1,
      "DRM_AllDynamic" = 2,
      "DRM_All" = 3,
    ...
    declare const enum EDepthCollisionEffect {
      "DCE_Bounce" = 1,
      "DCE_Glide" = 2,
      "DCE_Kill" = 4,
    }

    declare const enum EDeviceChallengeAttribute {
      "Invalid" = 0,
      "Strength" = 1,
      "Reflexes" = 2,
      "Intelligence" = 3,
    ...
    declare const enum EDeviceChallengeSkill {
      "Invalid" = 0,
      "Hacking" = 1,
      "Engineering" = 2,
      "Athletics" = 3,
    ...
    declare const enum EDeviceDurabilityState {
      "NOMINAL" = 0,
      "MALFUNCTIONING" = 1,
      "BROKEN" = 2,
      "DESTROYED" = 3,
    ...
    declare const enum EDeviceDurabilityType {
      "INVULNERABLE" = 0,
      "INDESTRUCTIBLE" = 1,
      "DESTRUCTIBLE" = 2,
    }

    declare const enum EDeviceStatus {
      "DISABLED" = -2,
      "UNPOWERED" = -1,
      "OFF" = 0,
      "ON" = 1,
    ...
    declare const enum EDocumentType {
      "FILE" = 0,
      "MAIL" = 1,
      "Invalid" = 2,
    }

    declare const enum EDodgeMovementInput {
      "Invalid" = 0,
      "Forward" = 1,
      "Right" = 2,
      "Left" = 3,
    ...
    declare const enum EDoorOpeningType {
    ...
    declare const enum EDoorSkillcheckSide {
      "BOTH" = 0,
      "ONE" = 1,
      "TWO" = 2,
    }

    declare const enum EDoorStatus {
      "SEALED" = -2,
      "LOCKED" = -1,
      "CLOSED" = 0,
      "OPENED" = 1,
    ...
    declare const enum EDoorTriggerSide {
      "OUTSIDE" = 0,
      "ONE" = 1,
      "TWO" = 2,
    }

    declare const enum EDoorType {
      "NONE" = 0,
      "INTERACTIVE" = 1,
      "AUTOMATIC" = 2,
      "PHYSICAL" = 3,
    ...
    declare const enum EDownedType {
      "Killed" = 0,
      "Finished" = 1,
      "Defeated" = 2,
      "Unconscious" = 3,
    ...
    declare const enum EDynamicDecalSpawnPriority {
      "RDDS_Normal" = 0,
      "RDDS_Highest" = 1,
    }

    declare const enum EEasingType {
      "EET_In" = 0,
      "EET_Out" = 1,
      "EET_InOut" = 2,
    }

    declare const enum EEffectOperationType {
      "START" = 0,
      "STOP" = 1,
      "BRAKE_LOOP" = 2,
    }

    declare const enum EEmitterGroup {
      "EG_Default" = 0,
      "EG_Group0" = 1,
      "EG_Group1" = 2,
      "EG_Group2" = 3,
    ...
    declare const enum EEntityHighlightType {
      "EHE_None" = 0,
    ...
    declare const enum EEntryColumn {
      "left" = 0,
      "right" = 1,
    }

    declare const enum EEnvColorGroup {
      "ECG_Default" = 0,
      "ECG_Sky" = 1,
      "ECG_Group0" = 2,
      "ECG_Group1" = 3,
    ...
    declare const enum EEnvManagerModifier {
      "EMM_None" = 0,
    ...
    declare const enum EEquipmentSide {
      "Left" = 0,
      "Right" = 1,
    }

    declare const enum EEquipmentState {
      "Unequipped" = 0,
      "Equipped" = 1,
      "Equipping" = 2,
      "Unequipping" = 3,
    ...
    declare const enum EExplosiveAdditionalGameEffectType {
      "none" = 0,
      "EMP" = 1,
    }

    declare const enum EFastTravelDeviceType {
      "DataTerm" = 0,
      "SubwayGate" = 1,
    }

    declare const enum EFastTravelSystemInstruction {
      "Forward" = 0,
      "Previous" = 1,
    }

    declare const enum EFastTravelTriggerType {
      "Manual" = 0,
      "Auto" = 1,
    }

    declare const enum EFeatureFlag {
      "FEATFLAG_Default" = 0,
      "FEATFLAG_Shadows" = 1,
    ...
    declare const enum EFocusClueInvestigationState {
      "NONE" = 0,
      "INSPECTED" = 1,
      "NOT_INSPECTED" = 2,
    }

    declare const enum EFocusForcedHighlightType {
      "INTERACTION" = 0,
    ...
    declare const enum EFocusOutlineType {
      "HOSTILE" = 0,
      "FRIENDLY" = 1,
      "NEUTRAL" = 2,
      "ITEM" = 3,
    ...
    declare const enum EForcedElevatorArrowsState {
      "Disabled" = 0,
      "ArrowsUp" = 1,
      "ArrowsDown" = 2,
    }

    declare const enum EFrameState {
      "NoScreenshot" = 0,
      "Loading" = 1,
      "HasScreenshot" = 2,
    }

    declare const enum EFreeVectorAxes {
      "FVA_One" = 1,
      "FVA_Two" = 2,
      "FVA_Three" = 3,
      "FVA_Four" = 4,
    ...
    declare const enum EGameplayRole {
      "UnAssigned" = 0,
      "None" = 1,
      "Alarm" = 2,
      "ControlNetwork" = 3,
    ...
    declare const enum EGlitchState {
      "NONE" = 0,
      "DEFAULT" = 1,
    ...
    declare const enum EGrenadeType {
      "Frag" = 0,
      "Flash" = 1,
      "Smoke" = 2,
      "Piercing" = 3,
    ...
    declare const enum EHandEquipSlot {
      "None" = 0,
      "Left" = 1,
      "Right" = 2,
    }

    declare const enum EHitReactionMode {
      "Regular" = 0,
      "ForceImpact" = 1,
      "ForceStagger" = 2,
      "ForceKnockdown" = 3,
    ...
    declare const enum EHitReactionZone {
      "Head" = 0,
      "ChestLeft" = 1,
      "ArmLeft" = 2,
      "HandLeft" = 3,
    ...
    declare const enum EHitShapeType {
      "None" = -1,
      "Flesh" = 0,
      "Metal" = 1,
      "Cyberware" = 2,
    ...
    declare const enum EHotkeyRequestType {
      "Assign" = 0,
      "Cycle" = 1,
      "Restore" = 2,
    }

    declare const enum EHudAvatarMode {
      "Connecting" = 0,
      "Disconnecting" = 1,
      "Holocall" = 2,
      "Audiocall" = 3,
    ...
    declare const enum EHudPhoneFunction {
      "Inactive" = 0,
      "DisplayingMessage" = 1,
      "IncomingCall" = 2,
      "Holocall" = 3,
    ...
    declare const enum EHudPhoneVisibility {
      "Invisible" = 0,
      "Showing" = 1,
      "Visible" = 2,
      "Hiding" = 3,
    ...
    declare const enum EIndustrialArmAnimations {
      "Idle" = 0,
      "RepairLoop" = 1,
      "RepairLoop2" = 2,
      "RepairLoopBroken" = 3,
    ...
    declare const enum EInitReactionAnim {
      "Shock" = 0,
      "Fear" = 1,
      "Curious" = 2,
      "Call" = 3,
    ...
    declare const enum EInkAnimationPlaybackOption {
      "PLAY" = 0,
      "STOP" = 1,
      "PAUSE" = 2,
      "RESUME" = 3,
    ...
    declare const enum EInputAction {
      "IACT_None" = 0,
      "IACT_Press" = 1,
      "IACT_Release" = 2,
      "IACT_Axis" = 3,
    ...
    declare const enum EInputCustomKey {
      "ICK_Pad_DigitLeftRight" = 273,
      "ICK_Pad_DigitUpDown" = 274,
      "ICK_Count" = 275,
    }

    declare const enum EInputKey {
      "IK_None" = 0,
      "IK_LeftMouse" = 1,
      "IK_RightMouse" = 2,
      "IK_MiddleMouse" = 3,
    ...
    declare const enum EInventoryComboBoxMode {
      "FromInventory" = 0,
      "FromEquipment" = 1,
    ...
    declare const enum EInventoryDataStatDisplayType {
      "CompareBar" = 0,
      "DisplayBar" = 1,
      "Value" = 2,
    }

    declare const enum EItemOperationType {
      "ADD" = 0,
      "REMOVE" = 1,
    }

    declare const enum EJuryrigTrapState {
      "UNARMED" = 0,
      "ARMED" = 1,
      "TRIGGERED" = 2,
    }

    declare const enum EKnockdownStates {
      "Invalid" = 0,
      "Start" = 1,
      "FallLoop" = 2,
      "Land" = 3,
    ...
    declare const enum ELightSequenceStage {
      "NONE" = 0,
      "INPROGRESS" = 1,
      "COMPLETE" = 2,
    }

    declare const enum ELightShadowCastingMode {
      "LSCM_None" = 0,
      "LSCM_Normal" = 1,
      "LSCM_OnlyDynamic" = 2,
      "LSCM_OnlyStatic" = 3,
    ...
    declare const enum ELightShadowSoftnessMode {
      "LSSM_ExtraSoft" = 0,
      "LSSM_Soft" = 1,
      "LSSM_Default" = 2,
      "LSSM_Sharp" = 3,
    ...
    declare const enum ELightState {
      "Reset" = 0,
      "DefaultColor" = 1,
      "Police" = 2,
      "VehicleHealth_Low" = 3,
    ...
    declare const enum ELightSwitchRandomizerType {
      "RANDOM" = 0,
      "RANDOM_PROGRESSIVE" = 1,
      "NONE" = 2,
    }

    declare const enum ELightType {
      "LT_Point" = 0,
      "LT_Spot" = 1,
      "LT_Area" = 2,
    }

    declare const enum ELightUnit {
      "LU_Lumen" = 0,
      "LU_Watt" = 1,
      "LU_Lux" = 2,
      "LU_Nit" = 3,
    ...
    declare const enum EMalfunctioningType {
      "NONE" = 0,
      "LOUD_ANNOUNCEMENT" = 1,
      "HALF_OPENING" = 2,
      "GLITCHING" = 3,
    ...
    declare const enum EMappinDisplayMode {
      "PLAYSTYLE" = 0,
      "ROLE" = 1,
      "MINIMALISTIC" = 2,
    }

    declare const enum EMappinVisualState {
      "Default" = 0,
      "Available" = 1,
      "Unavailable" = 2,
      "Inactive" = 3,
    ...
    declare const enum EMaterialModifier {
      "EMATMOD_HitProxy" = 0,
      "EMATMOD_WindData" = 1,
    ...
    declare const enum EMaterialPriority {
      "EMP_Normal" = 0,
      "EMP_Front" = 1,
    }

    declare const enum EMaterialShaderTarget {
      "MSH_Invalid" = 0,
      "MSH_VertexShader" = 1,
      "MSH_PixelShader" = 2,
      "MSH_MAX" = 3,
    ...
    declare const enum EMaterialShadingRateMode {
      "MSRM_Default" = 0,
      "MSRM_Disable" = 1,
      "MSRM_Force2x2" = 2,
    }

    declare const enum EMaterialVertexFactory {
      "MVF_Terrain" = 1,
      "MVF_MeshStatic" = 2,
      "MVF_MeshSkinned" = 3,
    ...
    declare const enum EMathOperationType {
      "Add" = 0,
      "Set" = 1,
    }

    declare const enum EMathOperator {
      "None" = 0,
      "Add" = 1,
      "Subtract" = 2,
      "Multiply" = 3,
    ...
    declare const enum EMeasurementSystem {
      "Metric" = 0,
      "Imperial" = 1,
    }

    declare const enum EMeasurementUnit {
      "Millimeter" = 0,
      "Centimeter" = 1,
      "Meter" = 2,
      "Kilometer" = 3,
    ...
    declare const enum EMeshParticleOrientationMode {
      "MPOM_Normal" = 0,
      "MPOM_MovementDirection" = 1,
      "MPOM_NoRotation" = 2,
    }

    declare const enum EMeshShadowImportanceBias {
    ...
    declare const enum EMeshStreamType {
      "MST_Position_3F" = 1,
    ...
    declare const enum EMeshVertexType {
      "MVT_StaticMesh" = 0,
    ...
    declare const enum EMissileRainPhase {
      "Init" = 0,
      "Phase1" = 1,
      "Phase2" = 2,
    }

    declare const enum EMoveAssistLevel {
      "Off" = 0,
      "SpecialAttacks" = 1,
      "AllAttacks" = 2,
    }

    declare const enum EMovementDirection {
      "left" = 0,
      "right" = 1,
      "up" = 2,
      "down" = 3,
    ...
    declare const enum ENcartStations {
      "NONE" = 0,
    ...
    declare const enum ENetworkRelation {
      "MASTER" = 0,
      "SLAVE" = 1,
      "NONE" = 2,
    }

    declare const enum ENeutralizeType {
      "None" = 0,
      "Killed" = 1,
      "Defeated" = 2,
      "Unconscious" = 3,
    ...
    declare const enum EOutlineType {
      "NONE" = 0,
      "GREEN" = 1,
      "RED" = 2,
      "YELLOW" = 3,
    ...
    declare const enum EParticleEventSpawnObject {
      "PESO_Particle" = 0,
      "PESO_Decal" = 1,
    }

    declare const enum EParticleEventType {
      "PET_Any" = 5,
      "PET_Death" = 0,
      "PET_OverLife" = 1,
      "PET_OverDistance" = 2,
    ...
    declare const enum EPaymentSchedule {
      "WEEKLY" = 0,
      "MONTHLY" = 1,
    }

    declare const enum EPermissionSource {
      "GAMEPLAY" = 0,
      "PLAYER" = 1,
      "QUEST" = 2,
    }

    declare const enum EPersonalLinkConnectionStatus {
      "NOT_CONNECTED" = 0,
      "CONNECTING" = 1,
      "CONNECTED" = 2,
      "DISCONNECTING" = 3,
    ...
    declare const enum EPersonalLinkSlotSide {
      "FRONT" = 0,
      "RIGHT" = 1,
      "BOTTOM" = 2,
    }

    declare const enum EPingType {
      "DIRECT" = 0,
      "SPACE" = 1,
    }

    declare const enum EPlayerMovementDirection {
      "Forward" = 0,
      "Right" = 1,
      "Back" = 2,
      "Left" = 3,
    ...
    declare const enum EPlaystyle {
      "NETRUNNER" = 0,
      "SOLO" = 1,
      "TECHIE" = 2,
    }

    declare const enum EPlaystyleType {
      "NONE" = -1,
      "TECHIE" = 0,
      "NETRUNNER" = 1,
    ...
    declare const enum EPreventionDebugProcessReason {
    ...
    declare const enum EPreventionHackLoopState {
      "IDLE" = 0,
      "INTRO_RADIO" = 1,
      "HACK_LOOP" = 2,
    }

    declare const enum EPreventionHeatStage {
      "Heat_0" = 0,
      "Heat_1" = 1,
      "Heat_2" = 2,
      "Heat_3" = 3,
    ...
    declare const enum EPreventionSystemInstruction {
      "Safe" = 0,
      "Active" = 1,
      "Off" = 2,
      "On" = 3,
    ...
    declare const enum EProgressBarContext {
      "QuickHack" = 0,
      "PhoneCall" = 1,
    }

    declare const enum EProgressBarState {
      "Available" = 0,
      "Blocked" = 1,
      "Invisible" = 2,
    }

    declare const enum EProgressBarType {
      "UPLOAD" = 0,
      "DURATION" = 1,
    }

    declare const enum EQuestFilterType {
      "DONT_CHANGE" = 0,
      "ALLOW_NONE" = 1,
      "ALLOW_COMBAT_ONLY" = 2,
      "ALLOW_ALL" = 3,
    ...
    declare const enum ERadioStationList {
      "AGGRO_INDUSTRIAL" = 0,
    ...
    declare const enum ERenderMeshStreams {
    ...
    declare const enum ERenderObjectType {
      "ROT_Static" = 0,
      "ROT_Terrain" = 1,
      "ROT_Road" = 2,
      "ROT_Skinned" = 20,
    ...
    declare const enum ERenderProxyType {
      "RPT_None" = 0,
      "RPT_Mesh" = 1,
      "RPT_PointLight" = 2,
      "RPT_SpotLight" = 3,
    ...
    declare const enum EReprimandInstructions {
      "INITIATE_FIRST" = 0,
    ...
    declare const enum ERevealDurationType {
      "TEMPORARY" = 0,
      "PERMANENT" = 1,
    }

    declare const enum ERevealPlayerType {
      "DONT_REVEAL" = 0,
      "REVEAL_ONCE" = 1,
    }

    declare const enum ERevealState {
      "STARTED" = 0,
      "CONTINUE" = 1,
      "STOPPED" = 2,
    }
    ...
    declare const enum EScreenRatio {
      "Screen_21x9" = 0,
      "Screen_9x21" = 1,
      "Screen_9x16" = 2,
      "Screen_3x4" = 3,
    ...
    declare const enum ESecurityAccessLevel {
      "ESL_NONE" = 0,
      "ESL_LOCAL" = 1,
      "ESL_0" = 2,
      "ESL_1" = 3,
    ...
    declare const enum ESecurityAreaType {
      "DISABLED" = 0,
      "SAFE" = 1,
      "RESTRICTED" = 2,
      "DANGEROUS" = 3,
    ...
    declare const enum ESecurityGateEntranceType {
      "OnlySideA" = 0,
      "OnlySideB" = 1,
      "AnySide" = 2,
    }

    declare const enum ESecurityGateResponseType {
      "AUDIOVISUAL_ONLY" = 0,
      "SEC_SYS_REPRIMAND" = 1,
      "SEC_SYS_COMBAT" = 2,
    }

    declare const enum ESecurityGateScannerIssueType {
      "NoIssues" = 0,
      "ScannerEmpty" = 1,
      "Overcrowded" = 2,
    ...
    declare const enum ESecurityGateStatus {
      "READY" = 0,
      "SCANNING" = 1,
      "THREAT_DETECTED" = 2,
    }

    declare const enum ESecurityNotificationType {
    ...
    declare const enum ESecuritySystemState {
      "UNINITIALIZED" = 0,
      "SAFE" = 1,
      "ALERTED" = 2,
      "COMBAT" = 3,
    ...
    declare const enum ESecurityTurretStatus {
      "THREAT" = -1,
      "SHOOTING" = 0,
      "WORKING" = 1,
      "SCANING" = 2,
    ...
    declare const enum ESecurityTurretType {
      "SIMPLE" = 0,
    }

    declare const enum ESenseLogSource {
      "Undefined" = 0,
    ...
    declare const enum ESensorDeviceStates {
      "NONE" = 0,
      "IDLE" = 1,
      "IDLEFORCED" = 2,
      "TARGETLOCK" = 3,
    ...
    declare const enum ESensorDeviceWakeState {
      "NONE" = -1,
      "CLOSED" = 0,
      "WAKEN" = 1,
      "OPEN" = 2,
    ...
    declare const enum EShouldChangeAttitude {
      "PERSISTENTLY" = 0,
      "TEMPORARLY" = 1,
    }

    declare const enum ESmartBulletPhase {
      "Init" = 0,
      "Parabolic" = 1,
      "Follow" = 2,
      "Linear" = 3,
    ...
    declare const enum ESmartHousePreset {
      "MorningPreset" = 0,
      "EveningPreset" = 1,
      "NightPreset" = 2,
    }

    declare const enum ESoundStatusEffects {
      "NONE" = 0,
      "DEAFENED" = 1,
      "SUPRESS_NOISE" = 2,
    }

    declare const enum ESpaceFillMode {
      "JustifyLeft" = 0,
      "JustifyRight" = 1,
      "JustifyCenter" = 2,
    }
    ...
    declare const enum EStatusEffectBehaviorType {
      "Invalid" = 0,
      "Basic" = 1,
      "Stoppable" = 2,
      "Unstoppable" = 3,
    ...
    declare const enum EStatusEffects {
      "Invalid" = 0,
      "WeaponJammed" = 1,
      "Blind" = 2,
      "SmokeScreen" = 3,
    ...
    declare const enum ESurveillanceCameraStatus {
      "THREAT" = -1,
      "STREAMING" = 0,
      "WORKING" = 1,
    }

    declare const enum ESwitchAction {
      "ToggleOn" = 0,
      "ToggleActivate" = 1,
    }

    declare const enum ESystemNotificationTypes {
    ...
    declare const enum ETakedownBossName {
      "Smasher" = 0,
      "Oda" = 1,
      "Royce" = 2,
      "Sasquatch" = 3,
    ...
    declare const enum ETargetManagerAnimGraphState {
      "MODELOOKAT" = 0,
      "IDLE" = 1,
      "JAMMED" = 2,
    }

    declare const enum ETauntType {
      "Normal" = 0,
      "Melee" = 1,
      "Ranged" = 2,
    }

    declare const enum ETelemetryData {
      "MeleeAttacksMade" = 0,
      "RangedAttacksMade" = 1,
      "BluelinesSelected" = 2,
      "MeleeKills" = 3,
    ...
    declare const enum ETextureAddressing {
      "TA_Wrap" = 0,
      "TA_Mirror" = 1,
      "TA_Clamp" = 2,
      "TA_MirrorOnce" = 3,
    ...
    declare const enum ETextureAnimationMode {
      "TAM_Speed" = 0,
      "TAM_LifeTime" = 1,
    }

    declare const enum ETextureComparisonFunction {
      "TCF_None" = 0,
      "TCF_Less" = 1,
      "TCF_Equal" = 2,
      "TCF_LessEqual" = 3,
    ...
    declare const enum ETextureCompression {
      "TCM_None" = 0,
      "TCM_DXTNoAlpha" = 1,
      "TCM_DXTAlpha" = 2,
      "TCM_RGBE" = 3,
    ...
    declare const enum ETextureFilteringMag {
      "TFMag_Point" = 0,
      "TFMag_Linear" = 1,
    }

    declare const enum ETextureFilteringMin {
      "TFMin_Point" = 0,
      "TFMin_Linear" = 1,
      "TFMin_Anisotropic" = 2,
    ...
    declare const enum ETextureFilteringMip {
      "TFMip_None" = 0,
      "TFMip_Point" = 1,
      "TFMip_Linear" = 2,
    }

    declare const enum ETextureRawFormat {
      "TRF_Invalid" = 0,
      "TRF_TrueColor" = 1,
      "TRF_DeepColor" = 2,
      "TRF_Grayscale" = 3,
    ...
    declare const enum ETimeOfYearSeason {
      "ETOYS_Spring" = 0,
      "ETOYS_Summer" = 1,
      "ETOYS_Autumn" = 2,
      "ETOYS_Winter" = 3,
    ...
    declare const enum EToggleActivationTypeComputer {
      "None" = 0,
      "Raise" = 1,
    }

    declare const enum EToggleOperationType {
      "ADD" = 0,
      "REMOVE" = 1,
    }

    declare const enum ETooltipsStyle {
      "Menus" = 0,
      "HUD" = 1,
    }

    declare const enum ETransformAnimationOperationType {
      "PLAY" = 0,
      "PAUSE" = 1,
      "RESET" = 2,
      "SKIP" = 3,
    ...
    declare const enum ETransitionMode {
      "GENTLE" = 0,
      "FORCED" = 1,
    }

    declare const enum ETransitionType {
      "EET_Linear" = 0,
      "EET_Sine" = 1,
      "EET_Cubic" = 2,
      "EET_Quad" = 3,
    ...
    declare const enum ETrapEffects {
      "Explosion" = 0,
      "Poisoned" = 1,
      "Bleeding" = 2,
      "Burning" = 3,
    ...
    declare const enum ETriggerOperationType {
      "ENTER" = 0,
      "EXIT" = 1,
    }
    ...
    declare const enum EUIActionState {
      "Invalid" = 0,
      "DEFAULT" = 1,
      "STARTED" = 2,
      "COMPLETED" = 3,
    ...
    declare const enum EUIStealthIconType {
      "Invalid" = 0,
      "HostileHuman" = 1,
      "Camera" = 2,
      "Turret" = 3,
    ...
    declare const enum EUploadProgramState {
      "STARTED" = 0,
      "COMPLETED" = 1,
    }

    declare const enum EVarDBMode {
      "Add" = 0,
      "Set" = 1,
      "Invalid" = 2,
    }

    declare const enum EVehicleBrandState {
      "Default" = 0,
      "New" = 1,
      "Selected" = 2,
    }

    declare const enum EVehicleOfferState {
      "Default" = 0,
      "New" = 1,
      "Owned" = 2,
      "Locked" = 3,
    ...
    declare const enum EVehicleSpawnBlockSide {
      "Front" = 0,
      "Back" = 1,
      "Left" = 2,
      "Right" = 3,
    ...
    declare const enum EVendorMode {
      "BuyItems" = 0,
      "SellItems" = 1,
      "Train" = 2,
      "Ripperdoc" = 3,
    ...
    declare const enum EViabilityDecision {
      "INCONCLUSIVE" = 0,
      "VIABLE" = 1,
      "NONVIABLE" = 2,
    }

    declare const enum EVirtualSystem {
      "None" = 0,
    ...
    declare const enum EVisionBlockerType {
      "Smoke" = 0,
      "OpticalCamo" = 1,
    ...
    declare const enum EWeaponNamesList {
    ...
    declare const enum EWidgetPlacementType {
      "DOCKED" = 0,
      "FLOATING" = 1,
    }

    declare const enum EWidgetState {
      "DEFAULT" = 0,
      "ON" = 1,
      "OFF" = 2,
      "INACTIVE" = 3,
    ...
    declare const enum EWindowBlindersStates {
      "NonInteractive" = 0,
      "Open" = 1,
      "Closed" = 2,
      "Tilted" = 3,
    ...
    declare const enum EWorkspotOperationType {
      "ENTER" = 0,
      "LEAVE" = 1,
    }

    declare const enum EWorldMapView {
      "Map" = 0,
    }

    declare const enum EWoundedBodyPart {
      "Invalid" = 0,
      "WoundedLeftArm" = 1,
      "WoundedRightArm" = 2,
      "WoundedLeftLeg" = 3,
    ...
    declare const enum ExpansionPopupType {
      "Default" = 0,
      "Features" = 1,
      "ThankYou" = 2,
      "Reloading" = 3,
    ...
    declare const enum ExpansionStatus {
      "NotAvailable" = 0,
      "Available" = 1,
      "Owned" = 2,
      "Downloaded" = 3,
    ...
    declare const enum ExplosiveTriggerDeviceLaserState {
      "GREEN" = 0,
      "RED" = 1,
      "DISABLED" = 2,
    }

    declare const enum ExtraEffect {
      "AccuracyVirus" = 0,
      "PeernoidVirus" = 1,
      "None" = 2,
    }

    declare const enum FTEntityRequirementsFlag {
      "None" = 0,
      "LookAtComponent" = 1,
      "ScanningComponent" = 2,
    ...
    declare const enum FTNpcMountingState {
      "Mounted" = 0,
      "Unmounted" = 1,
    }

    declare const enum Ft_Result {
      "Success" = 0,
    ...
    declare const enum Ft_TakedownStage {
      "Default" = 0,
      "Grappling" = 1,
      "Grappled" = 2,
      "Takedown" = 3,
    ...
    declare const enum Ft_TakedownType {
      "Lethal" = 0,
      "Nonlethal" = 1,
      "Breach" = 2,
    }

    declare const enum FunctionalTestsResultCode {
      "Valid" = 0,
    ...
    declare const enum gameAppearanceSource {
      "EntityResource" = 0,
      "PopulationSpawner" = 1,
      "CommunityEntry" = 2,
    ...
    declare const enum gameAutodriveLaneValidityResult {
      "OnValidLane" = 0,
      "NotOnValidLane" = 1,
      "NotOnRoad" = 2,
    }

    declare const enum gameBinkVideoAction {
      "Undefined" = 0,
      "Start" = 1,
      "Stop" = 2,
    }

    declare const enum gameBoolSignalAction {
      "None" = 0,
      "TurnOn" = 1,
      "TurnOff" = 2,
    }

    declare const enum gameBreachUITrackingChange {
      "NoChange" = 0,
      "StartedNew" = 1,
      "StoppedOnTimeout" = 2,
    ...
    declare const enum gameCameraCurve {
    ...
    declare const enum gameCombinedStatOperation {
      "Addition" = 0,
      "Subtraction" = 1,
      "Multiplication" = 2,
      "Division" = 3,
    ...
    declare const enum gameComparisonType {
      "EQUAL" = 0,
      "NOT_EQUAL" = 1,
      "LESS" = 2,
      "GREATER" = 3,
    ...
    declare const enum gameContactType {
      "Caller" = 0,
      "Texter" = 1,
    }

    declare const enum gameCoverHeight {
      "Invalid" = 0,
      "Low" = 1,
      "High" = 2,
    }

    declare const enum gameCrowdCreationDataMergeMode {
      "Average" = 0,
      "Override" = 1,
    }

    declare const enum gameCrowdEntryType {
      "Pedestrian" = 0,
      "Vehicle" = 1,
      "AV" = 2,
    }

    declare const enum gameDamageCallbackType {
      "HitTriggered" = 0,
      "MissTriggered" = 3,
      "HitReceived" = 1,
      "PipelineProcessed" = 2,
    ...
    declare const enum gameDamageListenerPipelineType {
      "None" = 0,
      "Damage" = 1,
      "ProjectedDamage" = 2,
      "All" = 4294967295,
    ...
    declare const enum gameDamagePipelineStage {
      "PreProcess" = 0,
      "Process" = 1,
    ...
    declare const enum gamedataAIActionSecurityNotificationType {
      "COMBAT" = 0,
      "DEESCALATE" = 1,
      "DEFAULT" = 2,
      "ILLEGAL_ACTION" = 3,
    ...
    declare const enum gamedataAIActionTarget {
      "AssignedVehicle" = 0,
      "CombatTarget" = 1,
      "CommandCover" = 2,
    ...
    declare const enum gamedataAIActionType {
      "BackUp" = 0,
      "BattleCry" = 1,
      "Block" = 2,
      "CallOff" = 3,
    ...
    declare const enum gamedataAIAdditionalTraceType {
      "Chest" = 0,
      "Hip" = 1,
      "Knee" = 2,
      "Undefined" = 3,
    ...
    declare const enum gamedataAIComparison {
      "Equal" = 0,
      "Greater" = 1,
      "GreaterOrEqual" = 2,
      "Less" = 3,
    ...
    declare const enum gamedataAIDifficulty {
      "Easy" = 0,
      "Hard" = 1,
      "Story" = 2,
      "VeryHard" = 3,
    ...
    declare const enum gamedataAIDirectorEntryStartType {
      "Default" = 0,
      "DespawnAllEnemies" = 1,
    ...
    declare const enum gamedataAIExposureMethodType {
      "BlindFire" = 0,
      "Lean" = 1,
      "StepOut" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataAIRole {
      "Follower" = 0,
      "Patrol" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataAISmartCompositeType {
      "Selector" = 0,
    ...
    declare const enum gamedataAISquadType {
      "Attitude" = 0,
      "Community" = 1,
      "Global" = 2,
      "Security" = 3,
    ...
    declare const enum gamedataAITacticType {
      "Assault" = 0,
      "Defend" = 1,
      "Flank" = 2,
      "Medivac" = 3,
    ...
    declare const enum gamedataAIThreatPersistenceSource {
      "AddThreat" = 0,
      "CatchUp" = 1,
    ...
    declare const enum gamedataAITicketType {
      "AndroidMelee" = 0,
      "BackUp" = 1,
      "BattleCry" = 2,
      "Block" = 3,
    ...
    declare const enum gamedataAttackSubtype {
      "BlockAttack" = 0,
      "BodySlamAttack" = 1,
      "ComboAttack" = 2,
      "CrouchAttack" = 3,
    ...
    declare const enum gamedataAttackType {
      "ChargedWhipAttack" = 0,
      "Direct" = 1,
      "Effect" = 2,
      "Explosion" = 3,
    ...
    declare const enum gamedataAttributeDataType {
      "BodyAttributeData" = 0,
      "CoolAttributeData" = 1,
    ...
    declare const enum gamedataBuildType {
    ...
    declare const enum gamedataCharacterRandomizationCategory {
      "Body" = 0,
      "Eyebrows" = 1,
      "Eyes" = 2,
      "Face" = 3,
    ...
    declare const enum gamedataChargeStep {
      "Idle" = 0,
      "Charging" = 1,
      "Charged" = 2,
      "Overcharging" = 3,
    ...
    declare const enum gamedataCheckType {
      "Category" = 0,
      "Evolution" = 1,
      "FullyModded" = 2,
      "None" = 3,
    ...
    declare const enum gamedataChoiceCaptionPartType {
      "Blueline" = 0,
      "Icon" = 1,
      "QuickhackCost" = 2,
      "Tag" = 3,
    ...
    declare const enum gamedataCompanionDistancePreset {
      "Close" = 0,
      "Far" = 1,
      "Medium" = 2,
      "VeryFar" = 3,
    ...
    declare const enum gamedataComputerUIStyle {
      "DarkBlue" = 0,
      "LightBlue" = 1,
      "Orange" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataConsumableBaseName {
      "Alcohol" = 0,
      "BonesMcCoy70" = 1,
    ...
    declare const enum gamedataConsumableType {
      "Drug" = 0,
      "Medical" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataContainerType {
      "AmmoCase" = 0,
      "Body" = 1,
      "ClothingContainer" = 2,
    ...
    declare const enum gamedataDamageType {
      "Chemical" = 0,
      "Electric" = 1,
      "Physical" = 2,
      "Thermal" = 3,
    ...
    declare const enum gamedataDataNodeType {
      "File" = 0,
      "Group" = 1,
      "Variable" = 2,
      "Value" = 3,
    ...
    declare const enum gamedataDefenseMode {
      "DefendAll" = 0,
      "DefendMelee" = 1,
      "DefendRanged" = 2,
      "NoDefend" = 3,
    ...
    declare const enum gamedataDevelopmentPointType {
      "Attribute" = 0,
      "Espionage" = 1,
      "Primary" = 2,
      "Secondary" = 3,
    ...
    declare const enum gamedataDeviceHackCategory {
      "ControlHack" = 0,
      "CovertHack" = 1,
      "DamageHack" = 2,
      "VehicleHack" = 3,
    ...
    declare const enum gamedataDeviceHackTier {
      "Tier1DeviceHack" = 0,
      "Tier2DeviceHack" = 1,
      "Tier3DeviceHack" = 2,
      "Tier4DeviceHack" = 3,
    ...
    declare const enum gamedataDistrict {
      "ArasakaWaterfront" = 0,
    ...
    declare const enum gamedataDriverCombatType {
      "CrystalDome" = 0,
      "Disabled" = 1,
      "Doors" = 2,
      "MountedWeapons" = 3,
    ...
    declare const enum gamedataEffectorTimeDilationDriver {
      "Source" = 0,
      "Target" = 1,
      "World" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataEquipmentArea {
      "AbilityCW" = 0,
      "ArmsCW" = 1,
      "BaseFists" = 2,
      "BotCPU" = 3,
    ...
    declare const enum gamedataEthnicity {
      "African" = 0,
      "AfricanAmerican" = 1,
      "AmericanEnglish" = 2,
      "Arabic" = 3,
    ...
    declare const enum gamedataFxAction {
      "EnterCharge" = 0,
      "EnterDischarge" = 1,
      "EnterLowAmmo" = 2,
      "EnterNoAmmo" = 3,
    ...
    declare const enum gamedataFxActionType {
      "BreakLoop" = 0,
      "Kill" = 1,
      "Start" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataGender {
      "Default" = 0,
      "Female" = 1,
      "Male" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataGrenadeDeliveryMethodType {
      "Homing" = 0,
      "Regular" = 1,
      "Sticky" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataGroupNodeGroupVariableDeriveInfo {
      "FullyDerived" = 0,
      "TypeDerived" = 1,
      "ValueChanged" = 2,
      "NotDerived" = 3,
    ...
    declare const enum gamedataGroupNodeInheritanceState {
      "Unresolved" = 0,
      "Resolving" = 1,
      "Resolved" = 2,
    }

    declare const enum gamedataHackCategory {
      "BreachingHack" = 0,
      "ControlHack" = 1,
      "CovertHack" = 2,
      "DamageHack" = 3,
    ...
    declare const enum gamedataHitPrereqConditionType {
      "AgentMoving" = 0,
      "AmmoState" = 1,
      "AttackSubType" = 2,
      "AttackTag" = 3,
    ...
    declare const enum gamedataImprovementRelation {
      "Direct" = 0,
      "Inverse" = 1,
      "None" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataIsHackable {
      "Always" = 0,
      "Dynamic" = 1,
      "Never" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataItemCategory {
      "Clothing" = 0,
      "Consumable" = 1,
      "Cyberware" = 2,
      "Gadget" = 3,
    ...
    declare const enum gamedataItemStructure {
    ...
    declare const enum gamedataItemType {
      "Clo_Face" = 0,
      "Clo_Feet" = 1,
      "Clo_Head" = 2,
      "Clo_InnerChest" = 3,
    ...
    declare const enum gamedataLifePath {
      "Corporate" = 0,
      "Nomad" = 1,
      "StreetKid" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataLocomotionMode {
      "Moving" = 0,
      "Static" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataMappinPhase {
      "CompletedPhase" = 0,
      "DefaultPhase" = 1,
      "DiscoveredPhase" = 2,
      "UndiscoveredPhase" = 3,
    ...
    declare const enum gamedataMappinVariant {
    ...
    declare const enum gamedataMeleeAttackDirection {
      "Center" = 0,
      "DownToUp" = 1,
      "LeftDownToRightUp" = 2,
      "LeftToRight" = 3,
    ...
    declare const enum gamedataMetaQuest {
      "MetaQuest1" = 0,
      "MetaQuest2" = 1,
      "MetaQuest3" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataMinigameActionType {
      "AccessPoint" = 0,
      "Both" = 1,
      "Device" = 2,
      "NPC" = 3,
    ...
    declare const enum gamedataMinigameCategory {
      "CameraAccess" = 0,
      "CyberwareAccess" = 1,
      "DataAccess" = 2,
    ...
    declare const enum gamedataMinigameTrapType {
      "Both" = 0,
      "Device" = 1,
      "NPC" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataMovementType {
      "Run" = 0,
      "Sprint" = 1,
      "Strafe" = 2,
      "Walk" = 3,
    ...
    declare const enum gamedataNewPerkSlotType {
    ...
    declare const enum gamedataNewPerkTierType {
      "AdeptNewPerkTier" = 0,
    ...
    declare const enum gamedataNewPerkType {
    ...
    declare const enum gamedataObjectActionType {
      "DeviceQuickHack" = 0,
      "Direct" = 1,
      "Item" = 2,
      "MinigameUpload" = 3,
    ...
    declare const enum gamedataOutput {
      "AskToFollowOrder" = 0,
      "AskToHolster" = 1,
      "BackOff" = 2,
      "BodyInvestigate" = 3,
    ...
    declare const enum gamedataParentAttachmentType {
      "Animated" = 0,
      "Skinned" = 1,
      "Slot" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataPerkArea {
      "Assault_Area_01" = 0,
      "Assault_Area_02" = 1,
      "Assault_Area_03" = 2,
      "Assault_Area_04" = 3,
    ...
    declare const enum gamedataPerkType {
    ...
    declare const enum gamedataPerkUtility {
      "ActiveUtility" = 0,
      "PassiveUtility" = 1,
      "TriggeredUtility" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataPerkWeaponGroupType {
    ...
    declare const enum gamedataPingType {
      "Device" = 0,
      "Door" = 1,
      "Elevator" = 2,
      "Junction" = 3,
    ...
    declare const enum gamedataPlayerBuild {
      "Cool" = 0,
      "Netrunner" = 1,
      "Reflexes" = 2,
      "Solo" = 3,
    ...
    declare const enum gamedataPlayerPossesion {
      "Default" = 0,
      "Johnny" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataProficiencyType {
      "Assault" = 0,
      "Athletics" = 1,
      "Brawling" = 2,
      "ColdBlood" = 3,
    ...
    declare const enum gamedataProjectileLaunchMode {
      "Regular" = 0,
      "Tracking" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataProjectileOnCollisionAction {
      "Bounce" = 0,
      "Pierce" = 1,
      "Stop" = 2,
      "StopAndStick" = 3,
    ...
    declare const enum gamedataQuality {
      "Common" = 0,
      "CommonPlus" = 1,
      "Epic" = 2,
      "EpicPlus" = 3,
    ...
    declare const enum gamedataReactionPresetType {
    ...
    declare const enum gamedataSearchFilterMaskType {
      "Att_Friendly" = 0,
      "Att_Hostile" = 1,
      "Att_Neutral" = 2,
      "Obj_Device" = 3,
    ...
    declare const enum gamedataSenseObjectType {
      "Camera" = 0,
      "Deadbody" = 1,
      "Follower" = 2,
      "Npc" = 3,
    ...
    declare const enum gamedataSimpleValueNodeValueType {
      "String" = 0,
      "Number" = 1,
      "Bool" = 2,
      "Ident" = 3,
    ...
    declare const enum gamedataSpawnableObjectPriority {
      "Crowd" = 0,
      "Quest" = 1,
      "Regular" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataStatPoolType {
      "AccumulatedDoT" = 0,
      "Adrenaline" = 1,
      "Aggressiveness" = 2,
      "Armor" = 3,
    ...
    declare const enum gamedataStatType {
    ...
    declare const enum gamedataStatType_1300DEPRECATED {
      "Acceleration" = 0,
      "Accuracy" = 1,
      "Adrenaline" = 2,
      "AimFOV" = 3,
    ...
    declare const enum gamedataStatusEffectAIBehaviorFlag {
      "AcceptsAdditives" = 0,
    ...
    declare const enum gamedataStatusEffectAIBehaviorType {
      "Basic" = 0,
      "None" = 1,
      "Stoppable" = 2,
      "Unstoppable" = 3,
    ...
    declare const enum gamedataStatusEffectType {
      "AndroidTurnOff" = 0,
      "AndroidTurnOn" = 1,
      "Berserk" = 2,
      "Berserker" = 3,
    ...
    declare const enum gamedataStatusEffectVariation {
      "Bike" = 0,
      "Default" = 1,
      "Vehicle" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataStimPriority {
      "High" = 0,
      "Low" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataStimPropagation {
      "Audio" = 0,
      "Visual" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataStimTargets {
      "All" = 0,
      "Puppets" = 1,
      "Vehicles" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataStimType {
      "AimingAt" = 0,
      "Alarm" = 1,
      "AreaEffect" = 2,
      "AskToFollowOrder" = 3,
    ...
    declare const enum gamedataSubCharacter {
      "Flathead" = 0,
      "Count" = 1,
      "Invalid" = 2,
    }

    declare const enum gamedataTrackingMode {
      "BeliefPosition" = 0,
      "LastKnownPosition" = 1,
      "RealPosition" = 2,
    ...
    declare const enum gamedataTraitType {
      "AssaultTrait01" = 0,
      "AthleticsTrait01" = 1,
      "BrawlingTrait01" = 2,
      "ColdBloodTrait01" = 3,
    ...
    declare const enum gamedataTriggerMode {
      "Burst" = 0,
      "Charge" = 1,
      "FullAuto" = 2,
      "Lock" = 3,
    ...
    declare const enum gamedataTweakDBType {
      "Invalid" = 0,
      "ForeignKey" = 1,
      "Int" = 2,
      "Float" = 3,
    ...
    declare const enum gamedataUICondition {
      "InEyesSubMenu" = 0,
      "InHandsSubMenu" = 1,
      "InSubMenu" = 2,
      "IsIntroFinished" = 3,
    ...
    declare const enum gamedataUIIconCensorFlag {
      "Drugs" = 0,
      "Gore" = 1,
      "Homosexuality" = 2,
      "None" = 3,
    ...
    declare const enum gamedataUINameplateDisplayType {
      "AfterScan" = 0,
      "Always" = 1,
      "Default" = 2,
      "Never" = 3,
    ...
    declare const enum gamedataVariableNodeVariableValueDeriveInfo {
      "NotDerived" = 0,
      "ArrayAddition" = 1,
    }

    declare const enum gamedataVehicleManufacturer {
      "Arch" = 0,
      "Archer" = 1,
      "Aurochs" = 2,
      "Brennan" = 3,
    ...
    declare const enum gamedataVehicleModel {
      "Aerondight" = 0,
      "Alvarado" = 1,
      "Basilisk" = 2,
      "Bratsk" = 3,
    ...
    declare const enum gamedataVehicleType {
      "Bike" = 0,
      "Car" = 1,
      "Panzer" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataVehicleUnlockType {
      "CourierMissions" = 0,
      "Quest" = 1,
      "StreetCred" = 2,
      "Count" = 3,
    ...
    declare const enum gamedataVendorType {
      "Armorsmith" = 0,
      "Clothes" = 1,
      "Clothing" = 2,
      "Cyberware" = 3,
    ...
    declare const enum gamedataWeaponEvolution {
      "Blade" = 0,
      "Blunt" = 1,
      "None" = 2,
      "Power" = 3,
    ...
    declare const enum gamedataWeaponManufacturer {
      "Corporation" = 0,
      "Street" = 1,
      "Count" = 2,
      "Invalid" = 3,
    ...
    declare const enum gamedataWidgetStyle {
      "Arasaka" = 0,
      "DarkNet" = 1,
      "Konopeki" = 2,
      "Maelstrom" = 3,
    ...
    declare const enum gamedataWorkspotActionType {
    ...
    declare const enum gamedataWorkspotCategory {
      "Any" = 0,
      "Eating" = 1,
      "Nervous" = 2,
      "Sitting" = 3,
    ...
    declare const enum gamedataWorkspotReactionType {
      "Anger" = 0,
      "BumpLeftBack" = 1,
      "BumpLeftFront" = 2,
      "BumpRightBack" = 3,
    ...
    declare const enum gamedataWorldMapFilter {
    ...
    declare const enum gamedeviceRequestType {
      "None" = 0,
      "External" = 1,
      "Remote" = 2,
      "Direct" = 3,
    ...
    declare const enum gameinfluenceEBoundingBoxType {
      "Colider" = 0,
      "Custom" = 1,
    }

    declare const enum gameinfluenceTestLineResult {
      "Fail" = 0,
      "Success" = 1,
      "Unknown" = 2,
    }
    ...
    declare const enum gameinteractionsBumpIntensity {
      "Invalid" = 0,
      "Light" = 1,
      "Medium" = 2,
      "Heavy" = 3,
    ...
    declare const enum gameinteractionsBumpLocation {
      "Invalid" = 0,
      "Front" = 1,
      "Back" = 2,
    }

    declare const enum gameinteractionsBumpSide {
      "Invalid" = 0,
      "Left" = 1,
      "Right" = 2,
    }

    declare const enum gameinteractionsBumpType {
      "Workspot" = 0,
      "Crowd" = 1,
    }

    declare const enum gameinteractionsChoiceLookAtType {
      "Root" = 0,
      "Slot" = 1,
      "Orb" = 2,
    }

    declare const enum gameinteractionsChoiceType {
      "QuestImportant" = 1,
      "AlreadyRead" = 2,
      "Inactive" = 4,
      "CheckSuccess" = 8,
    ...
    declare const enum gameinteractionsEBinaryOperator {
      "EBinaryOperator_and" = 0,
      "EBinaryOperator_or" = 1,
    }

    declare const enum gameinteractionsEGroupType {
      "EGT_default" = 0,
      "EGT_noInput" = 1,
      "EGT_hint" = 2,
    }

    declare const enum gameinteractionsEInteractionEventType {
      "EIET_activate" = 0,
      "EIET_deactivate" = 1,
    }

    declare const enum gameinteractionsELookAtTarget {
      "Entity" = 0,
      "Component" = 1,
    }

    declare const enum gameinteractionsELookAtTest {
      "Targeting" = 0,
      "Interaction" = 1,
    }

    declare const enum gameinteractionsELootChoiceType {
      "Available" = 0,
      "Unavailable" = 1,
      "Invisible" = 2,
    }

    declare const enum gameinteractionsELootVisualiserControlOperation {
      "Locked" = 1,
    }

    declare const enum gameinteractionsEPredicateType {
    ...
    declare const enum gameinteractionsEUnaryOperator {
      "EUnaryOperator_empty" = 0,
      "EUnaryOperator_not" = 1,
    }

    declare const enum gameinteractionsReactionState {
      "Idle" = 0,
      "Starting" = 1,
      "InInteraction" = 2,
      "Finishing" = 3,
    ...
    declare const enum gameinteractionsvisEVisualizerActivityState {
      "None" = 0,
      "Visible" = 1,
      "Available" = 2,
      "Active" = 3,
    ...
    declare const enum gameinteractionsvisEVisualizerDefinitionFlags {
      "None" = 0,
      "Fading" = 1,
      "HeadlineSelection" = 2,
      "QuestImportant" = 8,
    ...
    declare const enum gameinteractionsvisEVisualizerRuntimeFlags {
      "None" = 0,
      "Locked" = 1,
      "Failsafe" = 2,
      "Dbg_Active" = 4,
    ...
    declare const enum gameinteractionsvisEVisualizerType {
      "Device" = 0,
      "Dialog" = 1,
      "Loot" = 2,
      "Invalid" = 3,
    ...
    declare const enum gameinteractionsvisInteractionType {
      "LookAt" = 0,
      "Proximity" = 1,
    }
    ...
    declare const enum gamemappinsVerticalPositioning {
      "Above" = 0,
      "Same" = 1,
      "Below" = 2,
    }
    ...
    declare const enum gameprojectileOnCollisionAction {
      "None" = 0,
      "Stop" = 1,
      "Bounce" = 2,
      "StopAndStick" = 3,
    ...
    declare const enum gameprojectileParabolicUnknownVariable {
      "TargetPoint" = 0,
      "VelocityValue" = 1,
      "Accel" = 2,
    }
    ...
    declare const enum gametargetingSystemScriptFilter {
      "Melee" = 1,
      "Shooting" = 2,
      "Scanning" = 4,
      "QuickHack" = 8,
    ...
    declare const enum gametargetingSystemSearchFilterMaskValue {
      "Obj_Player" = 1,
      "Obj_Puppet" = 2,
      "Obj_Sensor" = 4,
      "Obj_Device" = 8,
    ...
    declare const enum gameuiBaseMenuGameControllerPuppetGenderInfo {
      "Male" = 0,
      "Female" = 1,
      "ShouldBeDetermined" = 2,
    }

    declare const enum gameuiBinkVideoStatus {
      "Idle" = 0,
      "NotStarted" = 1,
      "Initializing" = 2,
      "Playing" = 3,
    ...
    declare const enum gameuiCharacterCustomizationActionType {
      "Activate" = 0,
      "Deactivate" = 1,
      "EquipItem" = 2,
      "UnequipItem" = 3,
    ...
    declare const enum gameuiCharacterCustomizationEditTag {
      "NewGame" = 0,
      "HairDresser" = 1,
      "Ripperdoc" = 2,
    }

    declare const enum gameuiCharacterCustomizationPart {
      "Head" = 0,
      "Body" = 1,
      "Arms" = 2,
    }

    declare const enum gameuiCharacterCustomization_BrokenNoseStage {
      "CCBN_Disabled" = 0,
      "CCBN_Stage1" = 1,
      "CCBN_Stage2" = 2,
      "CCBN_FinalScene" = 3,
    ...
    declare const enum gameuiChoiceIndicatorType {
      "Default" = 0,
      "Speech" = 1,
      "Call" = 2,
      "Arrow" = 3,
    ...
    declare const enum gameuiChoiceListVisualizerType {
      "Interaction" = 0,
      "Dialog" = 1,
    }

    declare const enum gameuiCyberspaceElementType {
      "CyberspaceNPC" = 0,
      "CyberspaceFakeObject" = 1,
    }

    declare const enum gameuiDamageDigitsMode {
      "Off" = 0,
      "Individual" = 1,
      "Accumulated" = 2,
      "Both" = 3,
    ...
    declare const enum gameuiDamageDigitsStickingMode {
      "None" = 0,
      "Individual" = 1,
      "Accumulated" = 2,
      "Both" = 3,
    ...
    declare const enum gameuiDamageIndicatorMode {
      "Off" = 0,
      "DamageOnly" = 1,
      "On" = 2,
    }

    declare const enum gameuiDriverCombatCrosshairReticleDataState {
      "Default" = 0,
      "Dot" = 1,
    }

    declare const enum gameuiEBraindanceLayer {
      "Visual" = 0,
      "Audio" = 1,
      "Thermal" = 2,
    }

    declare const enum gameuiEClueDescriptorMode {
      "Invalid" = 0,
      "Add" = 1,
      "Finish" = 2,
    }

    declare const enum gameuiEIconOrientation {
      "Upright" = 0,
      "Entity" = 1,
    }

    declare const enum gameuiETooltipPlacement {
      "LeftCenter" = 0,
      "RightCenter" = 1,
      "LeftTop" = 2,
      "RightTop" = 3,
    ...
    declare const enum gameuiEWorldMapCameraMode {
      "TopDown" = 0,
      "ZoomLevels" = 1,
      "COUNT" = 2,
    }

    declare const enum gameuiEWorldMapDistrictView {
      "None" = 0,
      "Districts" = 1,
      "SubDistricts" = 2,
    }

    declare const enum gameuiGenericNotificationType {
      "Generic" = 0,
      "QuestUpdate" = 1,
      "Vendor" = 3,
      "ZoneAlert" = 4,
    ...
    declare const enum gameuiHackingMinigameState {
      "Unknown" = 0,
      "InProgress" = 1,
      "Succeeded" = 2,
      "Failed" = 3,
    ...
    declare const enum gameuiHitType {
      "Miss" = 0,
      "Glance" = 1,
      "Hit" = 2,
      "CriticalHit" = 3,
    ...
    declare const enum gameuiInputHintSortingPriority {
      "Top" = -2147483648,
      "Bottom" = 2147483646,
      "Invalid" = 2147483647,
    }

    declare const enum gameuiMappinGroupState {
      "Ungrouped" = 0,
      "Grouped" = 1,
      "GroupedCollection" = 2,
      "GroupedHidden" = 3,
    ...
    declare const enum gameuiOneTimeMessage {
      "XboxCompatibilityLimitation" = 0,
    }

    declare const enum gameuiPatchIntro {
      "Patch1500_NextGen" = 0,
      "Patch1600" = 1,
      "Patch2000" = 2,
      "Patch2000_EP1" = 3,
    ...
    declare const enum gameuiTutorialHiddenReason {
      "None" = 0,
    ...
    declare const enum grsHeistStatus {
      "Waiting" = 0,
      "Starting" = 1,
      "Lobby" = 2,
      "InGame" = 3,
    ...
    declare const enum gsmStateError {
      "StateError_OK" = 0,
    ...
    declare const enum inkBrushMirrorType {
      "NoMirror" = 0,
      "Horizontal" = 1,
      "Vertical" = 2,
      "Both" = 3,
    ...
    declare const enum inkBrushTileType {
      "NoTile" = 0,
      "Horizontal" = 1,
      "Vertical" = 2,
      "Both" = 3,
    ...
    declare const enum inkCacheMode {
      "Normal" = 0,
      "Minimap" = 1,
      "ExternalDynamicTexture" = 2,
    }

    declare const enum inkCharacterEventType {
      "CharInput" = 0,
      "MoveCaretForward" = 1,
      "MoveCaretBackward" = 2,
      "Delete" = 3,
    ...
    declare const enum inkCompositionParamType {
      "FLOAT" = 0,
      "VECTOR2" = 1,
    }

    declare const enum inkDiscreteNavigationDirection {
      "Up" = 0,
      "Right" = 1,
      "Down" = 2,
      "Left" = 3,
    ...
    declare const enum inkDisplayMode {
      "Invalid" = 0,
      "Basic" = 1,
      "BasicTranslatable" = 2,
      "Bold" = 3,
    ...
    declare const enum inkEBlurDimension {
      "Horizontal" = 0,
      "Vertical" = 1,
    }

    declare const enum inkEButtonState {
      "Normal" = 0,
      "Hover" = 1,
      "Press" = 2,
      "Disabled" = 3,
    ...
    declare const enum inkEChildOrder {
      "Forward" = 0,
      "Backward" = 1,
    }

    declare const enum inkEEndCapStyle {
      "BUTT" = 0,
      "SQUARE" = 1,
      "ROUND" = 2,
      "JOINED" = 3,
    ...
    declare const enum inkEJointStyle {
      "MITER" = 0,
      "BEVEL" = 1,
      "ROUND" = 2,
    }

    declare const enum inkELayerLoadPriority {
      "Normal" = 0,
      "High" = 1,
    }

    declare const enum inkELayerType {
      "Watermarks" = 0,
      "WaitingSign" = 1,
    ...
    declare const enum inkEOrientation {
      "Horizontal" = 0,
      "Vertical" = 1,
    }

    declare const enum inkEScrollDirection {
      "Vertical" = 0,
      "Horizontal" = 1,
    }

    declare const enum inkEShapeVariant {
      "Fill" = 0,
      "Border" = 1,
      "FillAndBorder" = 2,
    }

    declare const enum inkESizeRule {
      "Fixed" = 0,
      "Stretch" = 1,
    }

    declare const enum inkESliderDirection {
      "Horizontal" = 0,
      "Vertical" = 1,
    }

    declare const enum inkETextDirection {
      "LeftToRight" = 0,
      "RightToLeft" = 1,
      "Mixed" = 2,
    }

    declare const enum inkETextureResolution {
      "UltraHD_3840_2160" = 0,
      "FullHD_1920_1080" = 1,
      "HD_1280_720" = 2,
    }

    declare const enum inkEToggleState {
      "Normal" = 0,
      "Press" = 1,
      "Hover" = 2,
      "Disabled" = 3,
    ...
    declare const enum inkEVerticalAlign {
      "Fill" = 0,
      "Top" = 1,
      "Center" = 2,
      "Bottom" = 3,
    ...
    declare const enum inkFitToContentDirection {
      "None" = 0,
      "Horizontal" = 2,
      "Vertical" = 1,
    }

    declare const enum inkFocusCause {
      "Mouse" = 0,
      "Navigation" = 1,
      "SetDirectly" = 2,
      "Cleared" = 3,
    ...
    declare const enum inkGameScreenshotSortMode {
      "DateAscending" = 0,
      "DateDescending" = 1,
      "RatioAscending" = 2,
      "RatioDescending" = 3,
    ...
    declare const enum inkGradientMode {
      "Linear" = 0,
      "Rectangular" = 1,
    }

    declare const enum inkIconResult {
      "Success" = 0,
      "UnknownIconTweak" = 1,
    ...
    declare const enum inkInputHintHoldIndicationType {
      "FromInputConfig" = 0,
      "Press" = 1,
      "Hold" = 2,
    }

    declare const enum inkInputHintKeyCombinationType {
      "Or" = 0,
      "And" = 1,
    }

    declare const enum inkLanguageId {
      "EN" = 0,
      "PL" = 1,
      "JP" = 2,
      "DE" = 3,
    ...
    declare const enum inkLastTickVideoState {
      "NotDrawn" = 0,
      "Drawn" = 1,
      "Paused" = 2,
    }

    declare const enum inkLayerDrawingPolicy {
      "InOrder" = 0,
      "InParallel" = 1,
    }

    declare const enum inkLifePath {
      "Corporate" = 0,
      "StreetKid" = 2,
      "Nomad" = 1,
      "Invalid" = 3,
    ...
    declare const enum inkLineType {
      "RegularPatternSpacing" = 0,
      "LoosePatternSpacing" = 1,
    }

    declare const enum inkLoadingScreenType {
      "Unknown" = 0,
      "SplashScreen" = 1,
      "Initial" = 2,
      "FastTravel" = 3,
    ...
    declare const enum inkMarketingConsentPopupType {
      "None" = 0,
      "ThirdParty" = 1,
      "Newsletter" = 2,
      "Both" = 3,
    ...
    declare const enum inkMaskDataSource {
      "TextureAtlas" = 0,
      "DynamicTexture" = 1,
    }

    declare const enum inkMenuMode {
      "Unknown" = 0,
      "PauseMenu" = 1,
      "HubMenu" = 2,
      "CustomMenu" = 3,
    ...
    declare const enum inkMenuState {
      "Enabled" = 0,
      "Disabled" = 1,
    }

    declare const enum inkRumblePosition {
      "Both" = 0,
      "Left" = 1,
      "Right" = 2,
    }

    declare const enum inkRumbleStrength {
      "SuperLight" = 0,
      "Light" = 1,
      "Medium" = 2,
      "Heavy" = 3,
    ...
    declare const enum inkRumbleType {
      "Fast" = 0,
      "Pulse" = 1,
      "Slow" = 2,
    }

    declare const enum inkSaveStatus {
      "Invalid" = 0,
      "Local" = 1,
      "Upload" = 2,
      "Cloud" = 3,
    ...
    declare const enum inkSaveTransferStatus {
      "ExportStarted" = 0,
      "ExportSuccess" = 1,
      "ExportFailed" = 2,
      "ImportChecking" = 3,
    ...
    declare const enum inkSaveType {
      "ManualSave" = 0,
      "QuickSave" = 1,
      "AutoSave" = 2,
      "PointOfNoReturn" = 3,
    ...
    declare const enum inkSelectionRule {
      "Single" = 0,
      "Parent" = 1,
      "Children" = 2,
      "TypeBased" = 3,
    ...
    declare const enum inkSelectorChangeDirection {
      "None" = 0,
      "Prior" = 1,
      "Next" = 2,
    }

    declare const enum inkSpawnMode {
      "SingleAndMultiplayer" = 0,
      "OnlySingleplayer" = 1,
      "OnlyMultiplayer" = 2,
    }

    declare const enum inkState {
      "InitEngine" = 0,
      "PreGameMenu" = 3,
      "InitialLoading" = 4,
      "Game" = 5,
    ...
    declare const enum inkStyleOverrideType {
      "Invalid" = 0,
      "BigFont" = 1,
      "FluffReduction" = 2,
    }

    declare const enum inkTextReplaceAnimationControllerWidgetTextUsage {
      "BaseText" = 0,
      "TargetText" = 1,
      "NoUsage" = 2,
    }
    ...
    declare const enum inkVideoOptimizationState {
      "None" = 0,
      "TooManyBinks" = 1,
      "FullscreenBinkVisible" = 2,
    }

    declare const enum inkWidgetResourceVersion {
      "Default" = 0,
      "BrushToAtlas" = 1,
    }
    ...
    declare const enum inputEInputDevice {
      "INVALID" = 0,
      "KBD_MOUSE" = 1,
      "ORBIS" = 2,
      "DURANGO" = 3,
    ...
    declare const enum inputEInputScheme {
      "LEGACY" = 0,
      "AGILE" = 1,
      "ALTERNATIVE" = 2,
    }

    declare const enum inputESimplifiedInputDevice {
      "KBM" = 0,
      "PAD" = 1,
    }
    ...
    declare const enum locVoiceoverExpression {
    ...
    declare const enum meleeQueuedAttack {
      "Block" = 0,
      "Combo" = 1,
      "Crouch" = 2,
      "Final" = 3,
    ...
    declare const enum moveExplorationType {
      "None" = 0,
      "Ladder" = 1,
      "Jump" = 2,
      "Climb" = 3,
    ...
    declare const enum moveLineOfSight {
      "None" = 0,
      "Keep" = 1,
      "Avoid" = 2,
    }

    declare const enum moveLineOfSightPointPreference {
      "None" = 0,
      "ClosestToOwner" = 1,
      "ClosestToTarget" = 2,
    ...
    declare const enum moveLocomotionAction {
      "Undefined" = 0,
      "Exploration" = 1,
      "Idle" = 2,
      "IdleTurn" = 3,
    ...
    declare const enum moveMovementOrientationType {
      "NotSet" = 0,
      "Forward" = 1,
      "Backward" = 2,
      "Left" = 3,
    ...
    declare const enum moveMovementType {
      "Walk" = 0,
      "Run" = 1,
      "Sprint" = 2,
      "Strafe" = 3,
    ...
    declare const enum moveSecureFootingFailureReason {
      "Invalid" = 0,
      "Filter" = 1,
      "SimulationType" = 2,
      "Ground" = 3,
    ...
    declare const enum moveSecureFootingFailureType {
      "Invalid" = 0,
      "Edge" = 1,
      "Slope" = 2,
    }
    ...
    declare const enum navNavAreaID {
      "Unwalkable" = 0,
      "Terrain" = 1,
      "Crouchable" = 2,
      "Regular" = 3,
    ...
    declare const enum navNaviPositionType {
      "None" = 0,
      "Normal" = 1,
      "Projected" = 2,
    }

    declare const enum navPathQueryDebugStatus {
      "InvalidQuery" = 0,
      "Active" = 1,
    ...
    declare const enum physicsFractureFieldEffect {
      "FE_Fracture" = 0,
      "FE_Erase" = 1,
    }

    declare const enum physicsFractureFieldValueType {
      "FFVT_Impulse" = 0,
      "FFVT_Velocity" = 1,
    }

    declare const enum physicsMaterialFriction {
      "Enabled" = 0,
      "DisabledStrong" = 1,
      "Disabled" = 2,
    }

    declare const enum physicsMaterialTagAIVisibility {
      "None" = 0,
      "SemiTransparent" = 1,
      "Transparent" = 2,
    }

    declare const enum physicsMaterialTagProjectilePenetration {
      "TechOnly" = 0,
      "Any" = 1,
      "Medium" = 2,
      "Heavy" = 3,
    ...
    declare const enum physicsMaterialTagProjectileRicochet {
      "Default" = 0,
      "Always" = 1,
    }

    declare const enum physicsMaterialTagType {
      "AIVisibility" = 0,
      "PlayerVisibility" = 1,
    ...
    declare const enum physicsMaterialTagVehicleTraction {
      "Default" = 0,
      "Gravel" = 1,
    }

    declare const enum physicsMaterialTagVisibility {
      "None" = 0,
      "SemiTransparent" = 1,
      "Transparent" = 2,
      "Ignore" = 3,
    ...
    declare const enum physicsPhysicalSystemOwner {
      "Unknown" = 0,
    ...
    declare const enum physicsPhysicsJointAxis {
      "AxisX" = 0,
      "AxisY" = 1,
      "AxisZ" = 2,
      "Twist" = 3,
    ...
    declare const enum physicsPhysicsJointDriveType {
      "AxisX" = 0,
      "AxisY" = 1,
      "AxisZ" = 2,
      "Swing" = 3,
    ...
    declare const enum physicsPhysicsJointMotion {
      "Locked" = 0,
      "Limited" = 1,
      "Free" = 2,
    }

    declare const enum physicsProxyType {
      "Invalid" = 0,
      "PhysicalSystem" = 1,
    ...
    declare const enum physicsQueryUseCase {
      "Default" = 0,
      "ActionAnimation" = 1,
      "AI" = 2,
    ...
    declare const enum physicsRagdollShapeType {
      "CAPSULE" = 0,
      "BOX" = 1,
      "SPHERE" = 2,
    }
    ...
    declare const enum physicsSimulationType {
      "Static" = 0,
      "Dynamic" = 1,
      "Kinematic" = 2,
      "Invalid" = 3,
    ...
    declare const enum physicsStateValue {
      "Position" = 1,
      "Rotation" = 2,
      "Transform" = 3,
      "LinearVelocity" = 4,
    ...
    declare const enum physicsStaticCollisionShapeCategory {
      "Interior" = 0,
      "Exterior" = 1,
      "Architecture" = 2,
      "Decoration" = 3,
    ...
    declare const enum questAudioEventPrefetchMode {
      "AddEventPrefetch" = 0,
      "RemoveEventPrefetch" = 1,
    }

    declare const enum questAvailableVehicleType {
      "AnyCar" = 0,
      "AnyMotorcycle" = 1,
      "AnyVehicle" = 2,
      "SpecificVehicle" = 3,
    ...
    declare const enum questBehindInteractionEventType {
      "Undefined" = 0,
    ...
    declare const enum questBlockAction {
      "Block" = 0,
      "Unblock" = 1,
      "UnblockAll" = 2,
    }

    declare const enum questBriefingPlayerType {
      "Fullscreen" = 0,
      "Hud" = 1,
      "World" = 2,
    }

    declare const enum questBriefingSequencePlayerFunction {
      "StartSequence" = 0,
      "ChangeSequence" = 1,
      "FinishSequence" = 2,
    }

    declare const enum questBriefingType {
      "Fullscreen" = 0,
      "Hud" = 1,
      "World" = 2,
    }

    declare const enum questCameraParallaxSpace {
      "Trajectory" = 0,
      "Camera" = 1,
      "Chest" = 2,
    }

    declare const enum questCameraPlanesPreset {
      "Undefined" = 0,
      "VeryNear" = 1,
      "Near" = 2,
      "Normal" = 3,
    ...
    declare const enum questCharacterHitEventType {
      "Bullet" = 0,
      "Explosion" = 1,
      "Melee" = 2,
      "Other" = 3,
    ...
    declare const enum questChoiceSection_ConditionTypeMode {
      "Highlight" = 0,
      "Selection" = 1,
    }

    declare const enum questCombatNodeFunctions {
      "CombatTarget" = 0,
      "ShootAt" = 1,
      "LookAtTarget" = 2,
      "ThrowGrenade" = 3,
    ...
    declare const enum questCompanionPositions {
      "Behind" = 0,
      "InFront" = 1,
    }

    declare const enum questControlCrowdAction {
      "Disable" = 0,
      "Enable" = 1,
    }

    declare const enum questCustomStyle {
      "PlacidePhone" = 0,
      "VideoCallInterupt" = 1,
    }

    declare const enum questDistanceType {
      "Nearest" = 0,
      "Furthest" = 1,
    }

    declare const enum questDrillingState {
      "Undefined" = 0,
      "Started" = 1,
      "Finished" = 2,
    }

    declare const enum questEAddRemoveItemType {
      "AddItem" = 0,
      "RemoveByItemID" = 1,
      "RemoveByTag" = 2,
      "RemoveAll" = 3,
    ...
    declare const enum questEComparisonTypeEquality {
      "Equal" = 0,
      "NotEqual" = 1,
    }

    declare const enum questEDebugViewMode {
      "NONE" = 0,
      "CLAY" = 1,
      "PURE_GRAY" = 2,
      "PURE_WHITE" = 3,
    ...
    declare const enum questETimeDilationOverride {
      "None" = 0,
      "Ignore" = 1,
      "Inherit" = 2,
    }

    declare const enum questETimeShiftType {
      "ShiftByTime" = 0,
      "ShiftToHour" = 1,
    }

    declare const enum questEUIMenuState {
      "Open" = 0,
      "Closed" = 1,
    }

    declare const enum questEUseWeapon_MissileOffsetsSource {
      "None" = 0,
      "Predefined_Narrow" = 1,
      "Predefined_Wide" = 2,
      "TweakDB" = 3,
    ...
    declare const enum questGameplayRestrictionAction {
      "AddRestriction" = 0,
      "RemoveRestriction" = 1,
      "RemoveAllRestrictions" = 2,
    }

    declare const enum questImpulseMagnitude {
      "Any" = 0,
      "Low" = 1,
      "Medium" = 2,
      "High" = 3,
    ...
    declare const enum questInjectLootOperationType {
      "Inject" = 0,
      "Remove" = 1,
      "RemoveAll" = 2,
    }

    declare const enum questInputDevice {
      "Undefined" = 0,
      "KeyboardMouse" = 1,
      "XBoxGamepad" = 2,
      "PS4Gamepad" = 3,
    ...
    declare const enum questInputScheme {
      "Legacy" = 0,
      "Agile" = 1,
      "Alternative" = 2,
    }

    declare const enum questJournalAlignmentEventType {
      "Left" = 0,
      "Center" = 1,
      "Right" = 2,
    }

    declare const enum questJournalQuestEntry_NodeTypeNodeVersion {
      "Initial" = 0,
      "OptionalProperty" = 1,
    }

    declare const enum questJournalSizeEventType {
      "Maximize" = 0,
      "Minimize" = 1,
    }

    declare const enum questLanguageMode {
      "Undefined" = 0,
      "VoLang" = 1,
      "SubsLang" = 2,
      "TextLang" = 3,
    ...
    declare const enum questLogicalOperation {
      "AND" = 0,
      "OR" = 1,
      "XOR" = 2,
      "NAND" = 3,
    ...
    declare const enum questLookAtAction {
      "Nothing" = 0,
      "Reset" = 1,
      "Set" = 2,
    }

    declare const enum questLookAtDrivenTurnsMode {
      "Start" = 0,
      "Pause" = 1,
      "Resume" = 2,
      "Stop" = 3,
    ...
    declare const enum questLootTokenState {
      "Enabled" = 0,
      "Disabled" = 1,
      "Sealed" = 2,
      "Unsealed" = 3,
    ...
    declare const enum questMountConditionType {
      "OnMount" = 0,
      "OnUnmount" = 1,
    }

    declare const enum questMountVehicleOrigin {
      "Any" = 0,
      "NotStolen" = 1,
      "Stolen" = 2,
    }

    declare const enum questMountVehicleType {
      "Any" = 0,
      "Car" = 1,
      "Motorcycle" = 2,
    }

    declare const enum questMoveOnSplineType {
      "Simple" = 0,
      "Anim" = 1,
      "WithCompanion" = 2,
    }

    declare const enum questMoveType {
      "MoveOnSpline" = 0,
      "MoveTo" = 1,
      "RotateTo" = 2,
      "Patrol" = 3,
    ...
    declare const enum questMultiplayerAIDirectorFunction {
      "SetStatus" = 0,
      "SetCurrentPath" = 1,
    ...
    declare const enum questMultiplayerAIDirectorStatus {
      "Enabled" = 0,
      "Disabled" = 1,
    }

    declare const enum questMultiplayerHeistState {
      "Invalid" = 0,
      "Failure" = 1,
      "Victory" = 2,
    }

    declare const enum questNodeType {
      "Equip" = 0,
      "Unequip" = 1,
    }

    declare const enum questObjectInspectEventType {
      "Undefined" = 0,
      "Started" = 1,
      "Finished" = 2,
    }

    declare const enum questObjectInteractionEventType {
      "Undefined" = 0,
      "Entered" = 1,
      "Exited" = 2,
      "Executed" = 3,
    ...
    declare const enum questObjectScanEventType {
      "Undefined" = 0,
      "Started" = 1,
      "Finished" = 2,
    }

    declare const enum questPhaseNodeType {
      "Quest" = 0,
      "OpenWorld" = 1,
      "Combat" = 2,
      "Audio" = 3,
    ...
    declare const enum questPhoneCallMode {
      "Undefined" = 0,
      "Audio" = 1,
      "Video" = 2,
    }

    declare const enum questPhoneCallPhase {
      "Undefined" = 0,
      "IncomingCall" = 1,
      "StartCall" = 2,
      "EndCall" = 3,
    ...
    declare const enum questPhoneCallVisuals {
      "Default" = 0,
      "Somi" = 1,
    }

    declare const enum questPhoneStatus {
      "Available" = 0,
      "NotAvailable" = 1,
      "Busy" = 2,
      "Minimized" = 3,
    ...
    declare const enum questPhoneTalkingState {
      "Ended" = 0,
      "Initializing" = 1,
      "Talking" = 2,
      "Rejected" = 3,
    ...
    declare const enum questPlatform {
      "PC" = 0,
      "Console" = 1,
      "LastGenConsole" = 2,
      "CurrGenConsole" = 3,
    ...
    declare const enum questProximityProgressBarAction {
      "Activated" = 0,
      "Inactivated" = 1,
      "Completed" = 2,
      "WentOutOfRange" = 3,
    ...
    declare const enum questProximityProgressBarOrientation {
      "Undefined" = 0,
      "InRange" = 1,
      "OutOfRange" = 2,
    }

    declare const enum questProximityProgressBarState {
      "None" = 0,
      "Active" = 1,
      "Inactive" = 2,
      "Complete" = 3,
    ...
    declare const enum questQuestContentType {
      "EP1_MainQuest" = 0,
      "EP1_SideQuest" = 1,
      "EP1_Minor" = 2,
      "Fixer" = 3,
    ...
    declare const enum questQuickItemsSet {
      "Q001_Kereznikov_Heal_Phone" = 0,
      "Q003_All" = 1,
    }

    declare const enum questRandomizerMode {
      "Random" = 0,
      "IgnoreLastUsed" = 1,
      "IgnoreAllUsed" = 2,
    }

    declare const enum questScanningState {
      "NotScanned" = 0,
      "Scanned" = 1,
    }

    declare const enum questSceneConditionType {
      "Undefined" = 0,
      "IsInside" = 1,
      "IsOutside" = 2,
      "Entered" = 3,
    ...
    declare const enum questSetDestructionStateAction {
      "Undefined" = 0,
      "Trigger" = 1,
    }

    declare const enum questSocketType {
      "Undefined" = 0,
      "Input" = 1,
      "Output" = 2,
      "CutSource" = 3,
    ...
    declare const enum questSpawnDirectionPreference {
      "Behind" = 0,
      "InFront" = 1,
    }

    declare const enum questSpawnedVehicleType {
      "EntityReferenced" = 0,
      "AnyCar" = 1,
      "AnyMotorcycle" = 2,
      "SpecificVehicle" = 3,
    ...
    declare const enum questStorage {
      "Slow" = 0,
      "Fast" = 1,
    }

    declare const enum questSwitchWeaponModes {
      "PrimaryWeapon" = 0,
      "SecondaryWeapon" = 1,
    }

    declare const enum questTimeSkipMode {
      "PreSkip" = 0,
      "PostSkip" = 1,
    }

    declare const enum questTriggerConditionType {
      "Undefined" = 0,
      "Entered" = 1,
      "Exited" = 2,
      "IsInside" = 3,
    ...
    declare const enum questTutorialScreenMode {
      "Undefined" = 0,
      "Fullscreen" = 1,
      "Popup" = 2,
    }

    declare const enum questUIGameContextRequestType {
      "Push" = 0,
      "Pop" = 1,
      "Reset" = 2,
    }

    declare const enum questUseWorkspotNodeFunctions {
      "UseWorkspot" = 0,
      "JumpWorkspot" = 1,
      "StopWorkspot" = 2,
      "IdleOnlyMode" = 3,
    ...
    declare const enum questUseWorkspotTier {
      "Tier3" = 0,
      "Tier4" = 1,
    }

    declare const enum questVehicleCameraPerspective {
      "FPP" = 1,
      "TPP" = 0,
    }

    declare const enum questVehicleCameraType {
      "Undefined" = 0,
      "PuppetFPP" = 1,
      "TPP" = 2,
      "DriverFPP" = 3,
    ...
    declare const enum questVehicleCommandType {
      "Move On Spline" = 0,
      "Follow" = 1,
      "Move To" = 2,
      "Racing" = 3,
    ...
    declare const enum questVehicleWeaponQuestID {
      "Primary" = 0,
      "Secondary" = 1,
      "Tertiary" = 2,
      "Quaternary" = 3,
    ...
    declare const enum questVisionModeType {
      "Undefined" = 0,
      "FocusMode" = 1,
      "EnhancedMode" = 2,
    }

    declare const enum questWeaponUsageType {
      "Shoot" = 0,
      "StopShooting" = 1,
      "Reload" = 2,
      "StartAttack" = 3,
    ...
    declare const enum rendCaptureContextType {
      "SceneGamedef" = 0,
      "AnimViewer" = 1,
    }

    declare const enum rendContactShadowReciever {
      "CSR_None" = 0,
      "CSR_All" = 3,
      "CSR_CharacterOnly" = 2,
    }
    ...
    declare const enum rendEPathTracingLightUsage {
      "PTLU_Everywhere" = 0,
    ...
    declare const enum rendGIGroup {
      "GI_Group0" = 0,
      "GI_Group1" = 1,
    }

    declare const enum rendGIVolume {
      "GI_Exterior" = 0,
      "GI_Interior1" = 1,
      "GI_Interior2" = 2,
      "GI_Interior3" = 3,
    ...
    declare const enum rendLightAttenuation {
      "LA_InverseSquare" = 0,
      "LA_Linear" = 1,
    }

    declare const enum rendLightGroup {
      "LG_Group0" = 0,
      "LG_Group1" = 1,
      "LG_Group2" = 2,
      "LG_Group3" = 3,
    ...
    declare const enum rendPostFx_ScanningState {
      "Off" = 0,
      "Scanning" = 2,
      "Cancelled" = 3,
      "Complete" = 4,
    ...
    declare const enum rendRayTracedShadowsPlatform {
      "RLSP_All" = 0,
      "RLSP_PC" = 1,
      "RLSP_Consoles" = 2,
    }

    declare const enum rendResolutionMultiplier {
      "X1" = 1,
      "X2" = 2,
      "X4" = 4,
    }

    declare const enum rendScreenshotMode {
      "NONE" = 0,
      "NORMAL" = 1,
    ...
    declare const enum rendWindShapeAnchorPointDepth {
      "AP_CENTER" = 0,
      "AP_FRONT" = 1,
      "AP_BACK" = 2,
    }

    declare const enum rendWindShapeAnchorPointHorz {
      "AP_CENTER" = 0,
      "AP_RIGHT" = 1,
      "AP_LEFT" = 2,
    }

    declare const enum rendWindShapeAnchorPointVert {
      "AP_CENTER" = 0,
      "AP_TOP" = 1,
      "AP_BOTTOM" = 2,
    }
    ...
    declare const enum scnAdditionalSpeakerType {
      "Normal" = 0,
      "Holocall" = 1,
    }
    ...
    declare const enum scnBraindancePerspective {
      "FirstPerson" = 0,
      "ThirdPerson" = 1,
    }

    declare const enum scnBraindanceSpeed {
      "Any" = 0,
      "Slow" = 1,
      "Normal" = 2,
      "Fast" = 3,
    ...
    declare const enum scnChoiceNodeNsChoiceNodeFlags {
      "IsFocusClue" = 1,
      "IsValidInteractionFailsafeDisabled" = 2,
    }

    declare const enum scnChoiceNodeNsMappinLocation {
      "None" = 0,
      "Interaction" = 1,
      "Nameplate" = 2,
      "ObjectDefault" = 4,
    ...
    declare const enum scnChoiceNodeNsOperationMode {
      "attachToActor" = 0,
      "attachToProp" = 1,
    ...
    declare const enum scnChoiceNodeNsSizePreset {
      "small" = 0,
      "normal" = 1,
      "big" = 2,
      "Dialogue" = 3,
    ...
    declare const enum scnChoiceNodeNsTimedAction {
      "appear" = 0,
      "disappear" = 1,
      "disappearFading" = 2,
    }

    declare const enum scnChoiceNodeNsVisualizerStyle {
      "onScreen" = 0,
      "inWorld" = 1,
    }

    declare const enum scnContextualActorName {
      "Player" = 0,
      "VoicesetHolder" = 1,
      "Voice" = 2,
    ...
    declare const enum scnDialogLineType {
      "None" = 0,
      "Regular" = 1,
      "Holocall" = 2,
      "SceneComment" = 3,
    ...
    declare const enum scnDialogLineVisualStyle {
      "regular" = 0,
      "overHead" = 1,
      "radio" = 2,
      "globalTV" = 3,
    ...
    declare const enum scnDistractedConditionTarget {
      "Anyone" = 0,
      "Speaker" = 1,
      "SpeakerOrAddressee" = 2,
    }

    declare const enum scnEasingType {
      "Linear" = 0,
      "SinusoidalEaseInOut" = 1,
      "QuadraticEaseIn" = 2,
      "QuadraticEaseOut" = 3,
    ...
    declare const enum scnEndNodeNsType {
      "Terminating" = 0,
      "NonTerminating" = 1,
    }

    declare const enum scnEntityAcquisitionPlan {
      "findInContext" = 1,
      "findInWorld" = 2,
      "spawnDespawn" = 3,
      "findInEntity" = 4,
    ...
    declare const enum scnFastForwardMode {
      "Default" = 0,
      "GameplayReview" = 1,
    }

    declare const enum scnFastForwardStrategy {
      "automatic" = 0,
      "allow_fully" = 1,
      "block_on_start" = 2,
      "block_on_end" = 3,
    ...
    declare const enum scnMarkerType {
      "Local" = 0,
      "Global" = 1,
      "Entity" = 2,
    }

    declare const enum scnOffsetMode {
      "useRealOffset" = 0,
      "useCustomOffset" = 1,
    }

    declare const enum scnPlayDirection {
      "Forward" = 0,
      "Backward" = 1,
    }

    declare const enum scnPlaySpeed {
      "Pause" = 0,
      "Slow" = 1,
      "Normal" = 2,
      "Fast" = 3,
    ...
    declare const enum scnPropOwnershipTransferOptionsType {
      "TransferToWorkspotSystem_Automatic" = 0,
      "TransferToWorkspotSystem_Custom" = 1,
      "DisposeAfterScene" = 2,
    }

    declare const enum scnPuppetVehicleState {
      "IdleMounted" = 0,
      "IdleStand" = 1,
      "CombatWindowed" = 2,
      "CombatSeated" = 3,
    ...
    declare const enum scnRandomizerMode {
      "Random" = 0,
      "IgnoreLastUsed" = 1,
      "IgnoreAllUsed" = 2,
    }

    declare const enum scnReminderConditionProcessStep {
      "ReminderA" = 0,
      "ReminderB" = 1,
      "ReminderC" = 2,
      "Looping" = 3,
    ...
    declare const enum scnRidActorPlacement {
      "SceneOrigin" = 0,
      "Actual" = 1,
      "Player" = 2,
    }

    declare const enum scnRootMotionAnimPlacementMode {
      "Blend" = 0,
      "TeleportToStart" = 1,
      "PlayAtActorPosition" = 2,
    }

    declare const enum scnSceneCategoryTag {
      "voiceset" = 0,
      "mainQuests" = 1,
      "sideQuests" = 2,
      "minorQuests" = 3,
    ...
    declare const enum scnSceneVersionCheck {
      "OlderOrEqual" = 0,
      "Equal" = 1,
    }
    ...
    declare const enum scnWorldMarkerType {
      "Tag" = 0,
      "NodeRef" = 1,
    }
    ...
    declare const enum senseEShapeType {
      "INVALID" = -1,
      "BOX" = 0,
      "SPHERE" = 1,
      "CONE" = 2,
    ...
    declare const enum senseTracingFreq {
      "Never" = 0,
      "Lowest" = 1,
      "Low" = 2,
      "Medium" = 3,
    ...
    declare const enum sharedCommandResult {
      "Success" = 0,
      "NeedOptions" = 1,
      "Fail" = 2,
      "Abort" = 3,
    ...
    declare const enum sharedMenuItemType {
      "Action" = 0,
      "Checked" = 1,
      "Group" = 2,
      "Separator" = 3,
    ...
    declare const enum tempshitMapPinOperation {
      "Undefined" = 0,
      "Add" = 1,
      "Remove" = 2,
    }
    ...
    declare const enum textJustificationType {
      "Left" = 0,
      "Center" = 1,
      "Right" = 2,
    }

    declare const enum textLetterCase {
      "OriginalCase" = 0,
      "UpperCase" = 1,
      "LowerCase" = 2,
    }

    declare const enum textOverflowPolicy {
      "None" = 0,
      "DotsEnd" = 1,
      "DotsEndLastLine" = 2,
      "AutoScroll" = 3,
    ...
    declare const enum textTextDirection {
      "LeftToRight" = 0,
      "RightToLeft" = 1,
      "Mixed" = 2,
    }

    declare const enum textTextFlowDirection {
      "Auto" = 0,
      "LeftToRight" = 1,
      "RightToLeft" = 2,
    }

    declare const enum textTextShapingMethod {
      "Auto" = 0,
      "KerningOnly" = 1,
      "FullShaping" = 2,
    }

    declare const enum textVerticalAlignment {
      "Top" = 0,
      "Center" = 1,
      "Bottom" = 2,
    }

    declare const enum textWrappingPolicy {
      "Default" = 0,
      "PerCharacter" = 1,
    }
    ...
    declare const enum toolsMessageTokenType {
      "Text" = 0,
      "Location" = 1,
      "Tag" = 2,
    }
    ...
    declare const enum vehicleAudioEventAction {
      "OnPlayerDriving" = 0,
      "OnPlayerPassenger" = 1,
    ...
    declare const enum vehicleBikeCurve {
      "SpeedToTilt" = 0,
      "InputToTilt" = 1,
      "SpeedToTiltSpeed" = 2,
    }

    declare const enum vehicleCameraPerspective {
      "FPP" = 0,
      "TPPClose" = 1,
      "TPPMedium" = 2,
      "TPPFar" = 3,
    ...
    declare const enum vehicleCameraType {
      "FPP" = 0,
      "TPP" = 1,
    }

    declare const enum vehicleColorSelectorActiveInputMode {
      "None" = 0,
      "Gamepad" = 1,
      "KBM" = 2,
    }

    declare const enum vehicleColorSelectorActiveMode {
      "None" = 0,
      "Primary" = 1,
      "Secondary" = 2,
      "Lights" = 3,
    ...
    declare const enum vehicleColorSelectorActiveTab {
      "None" = 0,
      "Both" = 1,
      "Main" = 2,
      "Twintone" = 3,
    ...
    declare const enum vehicleColorSelectorMenuCloseReason {
      "Apply" = 0,
      "Reset" = 1,
      "Cancel" = 2,
    }

    declare const enum vehicleColorSelectorSBBar {
      "None" = 0,
      "Saturation" = 1,
      "Brightness" = 2,
    }

    declare const enum vehicleCoolExitImpulseLevel {
      "NoExit" = 0,
      "NoImpulse" = 1,
      "LowImpulse" = 2,
      "MaxImpulse" = 3,
    ...
    declare const enum vehicleDisabledReason {
      "FrontTire" = 0,
      "RearTire" = 1,
      "Other" = 2,
    }

    declare const enum vehicleELightMode {
      "Off" = 0,
      "On" = 1,
      "HighBeams" = 2,
    }

    declare const enum vehicleELightType {
      "Head" = 1,
      "Brake" = 2,
      "LeftBlinker" = 4,
      "RightBlinker" = 8,
    ...
    declare const enum vehicleEQuestVehicleDoorState {
      "ForceOpen" = 0,
      "ForceClose" = 1,
      "OpenAll" = 2,
      "CloseAll" = 3,
    ...
    declare const enum vehicleEQuestVehicleWindowState {
      "ForceOpen" = 0,
      "ForceClose" = 1,
      "OpenAll" = 2,
      "CloseAll" = 3,
    ...
    declare const enum vehicleEState {
      "Default" = 1,
      "On" = 2,
      "Disabled" = 3,
      "Destroyed" = 4,
    ...
    declare const enum vehicleESummonedVehicleType {
      "Any" = 0,
      "Car" = 1,
      "Motorcycle" = 2,
    }

    declare const enum vehicleEVehicleDoor {
      "seat_front_left" = 0,
      "seat_front_right" = 1,
      "seat_back_left" = 2,
      "seat_back_right" = 3,
    ...
    declare const enum vehicleEVehicleSpeedConditionType {
      "CT_EQUAL" = 0,
      "CT_NOT_EQUAL" = 1,
      "CT_GREATER" = 2,
      "CT_GREATER_EQUAL" = 3,
    ...
    declare const enum vehicleEVehicleWindowState {
      "Closed" = 0,
      "Open" = 1,
    }

    declare const enum vehicleExitDirection {
      "NoDirection" = -1,
      "Left" = 0,
      "Right" = 1,
      "Front" = 2,
    ...
    declare const enum vehicleFormationType {
      "FORMATION_TRIANGLE" = 0,
      "FORMATION_TURTLE" = 1,
      "FORMATION_QUINCUNX" = 2,
    }

    declare const enum vehicleGarageState {
      "NoVehiclesAvailable" = 0,
      "SummonAvailable" = 1,
      "SummonDisabled" = 2,
    }

    declare const enum vehiclePlayerToAIInterpolationType {
      "PTAIT_INSTANT" = 0,
      "PTAIT_LINEAR" = 1,
    ...
    declare const enum vehiclePoliceStrategy {
      "None" = 0,
    ...
    declare const enum vehicleQuestWindowDestruction {
      "window_f" = 0,
      "window_fl" = 1,
      "window_fr" = 2,
      "window_bl" = 3,
    ...
    declare const enum vehicleRaceUI {
      "PreRaceSetup" = 0,
      "CountdownStart" = 1,
      "RaceStart" = 2,
      "RaceEnd" = 3,
    ...
    declare const enum vehicleSummonFinishState {
      "Arrived" = 0,
    }

    declare const enum vehicleSummonState {
      "Idle" = 0,
      "EnRoute" = 1,
      "AlreadySummoned" = 2,
      "PathfindingFailed" = 3,
    ...
    declare const enum vehicleTPPCameraDistance {
      "Close" = 0,
      "Medium" = 1,
      "Far" = 2,
      "DriverCombatClose" = 3,
    ...
    declare const enum vehicleTPPCameraHeight {
      "Low" = 0,
      "High" = 1,
    }

    declare const enum vehicleVehicleDoorInteractionState {
      "Available" = 0,
      "Locked" = 1,
      "Disabled" = 2,
      "QuestLocked" = 3,
    ...
    declare const enum vehicleVehicleDoorState {
      "Closed" = 0,
      "Open" = 1,
      "Detached" = 2,
    }

    declare const enum vehicleVehicleNetrunnerQuickhackType {
      "ForceBrakes" = 0,
      "Explode" = 1,
      "Accelerate" = 2,
      "NONE" = 3,
    ...
    declare const enum workPropAttachMethod {
      "BonePosition" = 0,
      "RelativePosition" = 1,
      "Custom" = 2,
    }
    ...
    declare const enum workWorkspotDebugMode {
      "VisualLogToogle" = 2,
      "VisualLogOn" = 4,
      "VisualLogOff" = 8,
    ...
    declare const enum workWorkspotLogic {
      "Allow" = 0,
      "Deny" = 1,
    }

    declare const enum worldCommunityRegistryItemAreaNodeType {
      "Regular" = 0,
      "Streamable" = 1,
      "Background" = 2,
      "Count" = 3,
    ...
    declare const enum worldEClusteringModel {
      "HierarchicalGrid" = 0,
      "AlwaysLoaded" = 1,
      "Discard" = 2,
    }

    declare const enum worldEditablePrefabType {
      "Regular" = 0,
      "Decoration" = 1,
      "Quest" = 2,
      "Building" = 3,
    ...
    declare const enum worldNodeGroupType {
      "RegularGroup" = 0,
      "PrefabVariant" = 1,
      "DecorationCell" = 2,
      "ProxyGroup" = 3,
    ...
    declare const enum worldNodeSocketType {
      "Bidirectional" = 0,
      "Inward" = 1,
      "Outward" = 2,
      "Disabled" = 3,
    ...
    declare const enum worldObjectTag {
      "None" = 1701736270,
    ...
    declare const enum worldObjectTagExt {
      "None" = 1701736270,
      "Default" = 1634100548,
      "NonClimbable" = 1651262286,
    }

    declare const enum worldOffMeshConnectionType {
      "Door" = 0,
      "Ladder" = 1,
      "Floor" = 2,
      "Jump" = 3,
    ...
    declare const enum worldPatrolSplinePointTypes {
      "Workspot" = 0,
      "LookAt" = 1,
      "ClearLookAt" = 2,
    }

    declare const enum worldPrefabInteriorMapContribution {
      "Auto" = 0,
      "Include" = 1,
      "Discard" = 2,
    }

    declare const enum worldPrefabMinimapContribution {
      "Auto" = 0,
      "Include" = 1,
      "Discard" = 2,
    }

    declare const enum worldPrefabOwnership {
      "None" = 0,
      "Quest" = 1,
      "Audio" = 2,
      "Environment" = 3,
    ...
    declare const enum worldPrefabProxyMeshOnly {
      "SettingFromResource" = 0,
      "Enabled" = 1,
      "Disabled" = 2,
    }

    declare const enum worldPrefabStreamingImportance {
      "Auto" = 0,
      "P1" = 1,
      "P2" = 2,
      "P3" = 3,
    ...
    declare const enum worldPrefabStreamingOcclusion {
      "Default" = 0,
      "Exterior" = 1,
      "Interior" = 2,
      "OpenInterior" = 3,
    ...
    declare const enum worldPrefabType {
      "Regular" = 0,
      "Area" = 1,
      "Generated" = 2,
      "Decoration" = 3,
    ...
    declare const enum worldProxWindowsType {
      "SkipWindows" = 0,
      "PropagateWindows" = 1,
    ...
    declare const enum worldProxyBBoxSyncOptions {
      "Do_Nothing" = 0,
      "Pull" = 1,
      "Pull_And_Delete" = 2,
    }

    declare const enum worldProxyCoreAxis {
      "X" = 0,
      "Y" = 1,
      "Z" = 2,
    }

    declare const enum worldProxyGroupingNormals {
      "Around_Core_Axis" = 0,
      "Around_All_Axes" = 1,
    }

    declare const enum worldProxyMeshBuildType {
      "ProxyFromScratch" = 1,
      "ProxyFromProxy" = 0,
      "OnlyFromChildProxies" = 2,
    }

    declare const enum worldProxyMeshDependencyMode {
      "Auto" = 0,
      "Include" = 1,
      "Discard" = 2,
    }

    declare const enum worldProxyMeshOutputType {
      "RayScan" = 0,
    ...
    declare const enum worldProxyMeshTexRes {
      "RES_64" = 0,
      "RES_128" = 1,
      "RES_256" = 2,
      "RES_512" = 3,
    ...
    declare const enum worldProxyMeshUVType {
      "UvUseExisting" = 0,
      "UvGenerateNew" = 1,
    }

    declare const enum worldProxyNormalAngleStepSize {
      "STEP_90" = 0,
      "STEP_45" = 1,
      "STEP_15" = 2,
      "STEP_5" = 3,
    ...
    declare const enum worldProxySyncNormalSource {
      "From_Groups" = 0,
      "From_Face_Average" = 1,
    }

    declare const enum worldQuestPrefabLoadingMode {
      "Disable" = 0,
      "ForceLoad" = 1,
    }

    declare const enum worldQuestPreventionNotifierActivation {
      "OnFootOnly" = 0,
      "InVehicleOnly" = 1,
      "Always" = 2,
    }

    declare const enum worldQuestPreventionNotifierType {
      "Deescalation" = 0,
      "Clear" = 1,
    }

    declare const enum worldQuestType {
      "MainQuest" = 0,
      "SideQuest" = 1,
      "StreetStory" = 2,
      "MinorActivities" = 3,
    ...
    declare const enum worldRainIntensity {
      "NoRain" = 0,
      "LightRain" = 1,
      "HeavyRain" = 2,
    }

    declare const enum worldRoadMaterial {
      "Concrete" = 0,
      "ConcreteDestroyed" = 1,
      "Dirt" = 2,
    ...
    declare const enum worldRotatingMeshNodeAxis {
      "X" = 0,
      "Y" = 1,
      "Z" = 2,
    }

    declare const enum worldSpeedSplineOrientationMarkerType {
    ...
    declare const enum worldStreamingDataGroup {
      "Base" = 0,
      "EP1" = 1,
    }

    declare const enum worldStreamingSectorCategory {
      "Exterior" = 0,
      "Interior" = 1,
      "Quest" = 2,
      "Navigation" = 3,
    ...
    declare const enum worldStreamingTestCheckpointType {
      "BeginMove" = 0,
      "EndMove" = 1,
    }

    declare const enum worldTrafficLanePersistentFlags {
      "FromRoadSpline" = 1,
      "Bidirectional" = 2,
      "PatrolRoute" = 4,
      "Pavement" = 8,
    ...
    declare const enum worldTrafficLightColor {
      "GREEN" = 0,
      "RED" = 1,
      "YELLOW" = 2,
      "INVALID" = 3,
    ...
    declare const enum worldTrafficMovementBehavior {
      "Pedestrian" = 0,
      "Car" = 1,
    }

    declare const enum worldTrafficSplineNodeUsage {
      "Pavement" = 0,
      "Road" = 1,
    }

    declare const enum worldTrafficSpotDirection {
      "Forward" = 0,
      "Backward" = 1,
      "Both" = 2,
    }
